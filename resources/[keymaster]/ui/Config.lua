...
function Config.Clothes.loadData()
    ...
    table.insert(data, {
        ...
        index = exports.core:GetPlayerSkinData('tshirt_1') or 1,
        index2 = 2,
        indexName = 'tshirt_2',
        zoomOffset = 0.75,
        camOffset = 0.15,
    ...
    table.insert(data, {
        ...
        index = exports.core:GetPlayerSkinData('tshirt_2') or 1,
        zoomOffset = 0.75,
        camOffset = 0.15,
    })
    table.insert(data, {
        ...
        indexList = {}, 
        skinchanger = 'torso_1',
        index = exports.core:GetPlayerSkinData('torso_1') or 1,
        index2 = 4,
        indexName = 'torso_2',
        zoomOffset = 0.75,
        camOffset = 0.15,
    ...
    table.insert(data, {
        ...
        indexList = {}, 
        skinchanger = 'torso_2',
        index = exports.core:GetPlayerSkinData('torso_2') or 1,
        zoomOffset = 0.75,
        camOffset = 0.15,
    })
    table.insert(data, {
        ...
        indexList = {}, 
        skinchanger = 'arms',
        index = exports.core:GetPlayerSkinData('arms') or 1,
        zoomOffset = 0.75,
        camOffset = 0.15,
    })
    -- BAS
    table.insert(data, {
        ...
        indexList = {}, 
        skinchanger = 'pants_1',
        index = exports.core:GetPlayerSkinData('pants_1') or 1,
        index2 = 7,
        indexName = 'pants_2',
        zoomOffset = 0.8,
        camOffset = -0.5,
    ...
    table.insert(data, {
        ...
        indexList = {}, 
        skinchanger = 'pants_2',
        index = exports.core:GetPlayerSkinData('pants_2') or 1,
        zoomOffset = 0.8,
        camOffset = -0.5,
    })
    table.insert(data, {
        ...
        indexList = {}, 
        skinchanger = 'shoes_1',
        index = exports.core:GetPlayerSkinData('shoes_1') or 1,
        index2 = 9,
        indexName = 'shoes_2',
        zoomOffset = 0.8,
        camOffset = -0.8,
    ...
    table.insert(data, {
        ...
        indexList = {}, 
        skinchanger = 'shoes_2',
        index = (exports.core:GetPlayerSkinData('shoes_2') == 0 and 1 or exports.core:GetPlayerSkinData('shoes_2') == nil and 1 or exports.core:GetPlayerSkinData('shoes_2')),
        zoomOffset = 0.8,
        camOffset = -0.8,
    })
    --CALQUES
    table.insert(data, {
        ...
        index = exports.core:GetPlayerSkinData('decals_1') or 1,
        zoomOffset = 0.75,
        camOffset = 0.15,
    })
