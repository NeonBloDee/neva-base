    ...
    ["ears_1"] = {
        ...
        resetValue = {
            ["ears_2"] = {
                default = 0, 
                maxValue = function()
                    return GetNumberOfPedPropTextureVariations(PlayerPedId(), 0, exports.sunny:GetPlayerSkinData('ears_1') or 1 - 1)
                end
            }
        }
    },
...
RegisterNUICallback("shop:renameOutfit", function(data, cb)
    ...
    TriggerServerEvent('sunny:clotheshop:renameClothe', data.label, newName)
    CloseShopMenu()
end)
...
RegisterNUICallback("shop:deleteOutfit", function(data)
    if not isInClotheshop then return end
    TriggerServerEvent('sunny:clotheshop:deleteClothe', data.label)
    CloseShopMenu()
end)
    ...
    ESX.TriggerServerCallback('sunny:clotheshop:haveMoney', function(valid)
        if valid then
            ...
            TriggerEvent("skinchanger:getSkin", function(skin)
                ...
                TriggerServerEvent('sunny:clotheshop:saveTenue', tempTableVet, newName)
            end)
        end
    end)
end)
