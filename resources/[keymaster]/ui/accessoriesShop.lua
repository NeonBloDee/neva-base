    ...
    ["bproof_1"] = {
        ...
        resetValue = {
            ["bproof_2"] = {
                default = 0, 
                maxValue = function()
                    return GetNumberOfPedTextureVariations(PlayerPedId(), 11, exports.core:GetPlayerSkinData('bproof_1') or 1 - 1)
                end
            }
        },
    },
...
RegisterNUICallback("shop:buyAccessories", function(clotheData)
    print('buyyyyy ta mere la pute', table.unpack(clotheData))
        ...
        local data = {data = {{name = clotheData.name, number = exports.core:GetPlayerSkinData(clotheData.name)}, {name = creatorData[clotheData.name].secondeName, number = exports.core:GetPlayerSkinData(creatorData[clotheData.name].secondeName)}}}
        data.label = label
