      ...
      <div className="sidebar__header">
        <div className="d-flex mb-4">
          ...
          <div className="d-flex flex-column">
            <h3 className="sidebar__title">
              <span className="text-regular text-light-gray">Bienvenue,</span>
              <br />
              {policeName}
            </h3>
        ...
        <div className="sidebar__search">
          <button onClick={() => setShowSearchModal(true)} className="sidebar__search-button">
            <img src={searchIcon} alt="Icône de recherche" className="sidebar__search-button-icon-img" />
          </button>
          <input
      ...
      <div className="sidebar__main">
        <ul className="sidebar__list">
          ...
          >
            ...
            <span className="sidebar__list-text">Accueil</span>
          </NavLink>
          ...
          >
            ...
            <span className="sidebar__list-text">Dossiers</span>
          </NavLink>
          ...
          >
            <div className="d-flex justify-content-between align-items-center w-100">
              <div className="d-flex align-items-center">
                ...
                <span className="sidebar__list-text">Recherchés</span>
              </div>
          ...
          >
            ...
            <span className="sidebar__list-text">Amendes</span>
          </NavLink>
          ...
          >
            ...
            <span className="sidebar__list-text">Département</span>
          </NavLink>
          ...
          >
            ...
            <span className="sidebar__list-text">Caméras</span>
          </NavLink>
          ...
          >
            ...
            <span className="sidebar__list-text">Carte en direct</span>
          </NavLink>
        </ul>
      </div>
