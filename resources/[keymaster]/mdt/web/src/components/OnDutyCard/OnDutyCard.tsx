          ...
          <div className="row g-3 mb-4">
            <div className="col-md-12 col-lg-4">
              <div className="d-flex align-items-center mb-2">
                ...
                <span className="on-duty-card__text text-semibold">Informations de grade</span>
              </div>
            ...
            <div className="col-md-12 col-lg-4">
              <div className="d-flex align-items-center mb-2">
                ...
                <span className="on-duty-card__text text-semibold">Horaires de service</span>
              </div>
            ...
            <div className="col-md-12 col-lg-4">
              <div className="d-flex align-items-center mb-2">
                ...
                <span className="on-duty-card__text text-semibold">Date de nomination</span>
              </div>
