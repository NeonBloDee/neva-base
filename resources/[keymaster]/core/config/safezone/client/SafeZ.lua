...
if not IsDuplicityVersion() then
    SunnyConfigSafe.SafeZone.list["POLICE"] = PolyZone:Create({
  ...
  --maxZ = 34.144115447998
    ...
    SunnyConfigSafe.SafeZone.list["parkingcentral"] = PolyZone:Create({
    ...
    SunnyConfigSafe.SafeZone.list["pillboxhospital"] = PolyZone:Create({
    ...
    SunnyConfigSafe.SafeZone.list["MOTORCYCLE"] = PolyZone:Create({
    ...
    SunnyConfigSafe.SafeZone.list["jail"] = PolyZone:Create({
    ...
    SunnyConfigSafe.SafeZone.list["accessoireshop"] = PolyZone:Create({
...
--[[     SunnyConfigSafe.SafeZone.list["missionrow"] = PolyZone:Create({
...
--[[     SunnyConfigSafe.SafeZone.list["newhospitalsud"] = PolyZone:Create({
    ...
    SunnyConfigSafe.SafeZone.list["BENNYS"] = PolyZone:Create({
  ...
  --maxZ = 72.555305480958
    ...
    SunnyConfigSafe.SafeZone.list["GOUVERNEMENT"] = PolyZone:Create({
  ...
  --maxZ = 58.422340393066
    ...
    SunnyConfigSafe.SafeZone.list["fairyfest"] = PolyZone:Create({
    ...
    SunnyConfigSafe.SafeZone.list["boatshop"] = PolyZone:Create({
        ...
        SunnyConfigSafe.SafeZone.list["carshop"] = PolyZone:Create({
   ...
   -- SunnyConfigSafe.SafeZone.list["hayesmotors"] = PolyZone:Create({
 ...
 --   SunnyConfigSafe.SafeZone.list["hardtuned"] = PolyZone:Create({
 ...
 --   SunnyConfigSafe.SafeZone.list["bennysnord"] = PolyZone:Create({
 ...
 --       vector2(70.333892822266, 6469.9609375)
  ...
  --      name = "bennysnord",
    ...
    SunnyConfigSafe.SafeZone.list["bahamas"] = PolyZone:Create({
...
--    SunnyConfigSafe.SafeZone.list["afk"] = PolyZone:Create({
...
--        name = "dreamworks",
  --  })
    ...
    SunnyConfigSafe.SafeZone.list["parking2"] = PolyZone:Create({
  ...
  --  SunnyConfigSafe.SafeZone.list["uwucoffe"] = PolyZone:Create({
...
--        name = "uwucoffe",
 ...
 --   SunnyConfigSafe.SafeZone.list["autoexotic"] = PolyZone:Create({
 ...
 --   SunnyConfigSafe.SafeZone.list["paleto_carshop"] = PolyZone:Create({
...
--SunnyConfigSafe.SafeZone.list["ambulancenord"] = PolyZone:Create({
 ...
 --       name = "ambulancenord",
  --  })
    ...
    SunnyConfigSafe.SafeZone.list["pacificbluffs"] = PolyZone:Create({
    ...
    SunnyConfigSafe.SafeZone.list["ltd_paletobay"] = PolyZone:Create({
    ...
    SunnyConfigSafe.SafeZone.list["bcso_paleto"] = PolyZone:Create({
 ...
 --  SunnyConfigSafe.SafeZone.list["bikeshop"] = PolyZone:Create({
 ...
 --   })
   ...
   -- SunnyConfigSafe.SafeZone.list["ambulancesandy"] = PolyZone:Create({
...
--    })
  ...
  --      SunnyConfigSafe.SafeZone.list[k] = v.zone
 --   end
    ...
    function GetSafeZoneLocation(position)
        ...
        for k,v in pairs(SunnyConfigSafe.SafeZone.list) do  
    ...
    Citizen.CreateThread(function()
        ...
        for k,v in pairs(SunnyConfigSafe.SafeZone.list) do
            SunnyConfigSafe.SafeZone.list[k]:onPointInOut(PolyZone.getPlayerPosition, function(isPointInside, point)
                if isPointInside then
                    NetworkSetFriendlyFireOption(false)
                    SetCurrentPedWeapon(Player.playerPed, `WEAPON_UNARMED`, true)
                    ESX.ShowNotification("Vous entrez en SafeZone.")
                    isinsafezone = true
                    ...
                    Citizen.CreateThread(function()
                        while isinsafezone do
                            ...
                            for i = 1, #SunnyConfigSafe.SafeZone.disabledKeys, 1 do
                                DisableControlAction(SunnyConfigSafe.SafeZone.disabledKeys[i].group, SunnyConfigSafe.SafeZone.disabledKeys[i].key, true)
                            end
                        end
                    end)
                else
                    ...
                    ESX.ShowNotification("Vous sortez de SafeZone")
                end
            end)
        end
    end)
