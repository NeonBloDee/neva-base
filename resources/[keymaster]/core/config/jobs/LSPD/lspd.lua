...
------ LSPD -----
    Police = {
        ...
        Camera = {
            DevMode = false,
            WatchCoords = vector3(81.411797, -378.086945, 41.331711),
            Items = {
            ["bodycam"] = "bodycam", 
            ["dashcam"] = "dashcam",
            },
            Lang = {
            -- TEXTE BOUTON E
            ["e-button-text"] = "Appuyez sur [~g~E~w~] pour accéder aux caméras.",
            
            -- NOTIFICATIONS
            ["menu-updated"] = "Le menu a changé. Le menu est en cours de refonte...",
            ["no-active-cam"] = "Aucune caméra active trouvée.",
            ["bodycam-off"] = "Bodycam désactivée.",
            ["bodycam-on"] = "Bodycam activée.",
            ["dashcam-off"] = "Dashcam désactivée.", 
            ["dashcam-on"] = "Dashcam activée.",
            ["near-vehicles"] = "Vous n'êtes pas à proximité d'un véhicule.",
            
            -- MENUS
            ["exit-cam"] = "Quitter la caméra",
            ["main-menu-title"] = "Caméras",
            ["bodycam-list"] = "Liste des Bodycams",
            ["bodycam-list-desc"] = "Cliquez pour voir les agents avec une bodycam active.",
            ["dashcam-list"] = "Liste des Dashcams",
            ["dashcam-list-desc"] = "Cliquez pour voir les véhicules avec une dashcam.",
            
            ["watch-bodycam"] = "Regarder la caméra de l'agent %s",
            ["watch-dashcam"] = "Regarder la dashcam de l'agent %s",
            },
        },
    
        Position = {
            cloakroom = vector3(-1098.310669, -831.797791, 14.282785),
            chest = vector3(-1074.0249023438, -833.35290527344, 19.292392730713),  
            boss = vector3(-1098.4805908203, -837.26812744141, 19.320915222168), 
            armory = vector3(-1081.5133056641, -822.58520507812, 23.152784347534),
            accueil = vec3(-1101.9840087891, -830.46313476562, 19.320636749268),
        },
