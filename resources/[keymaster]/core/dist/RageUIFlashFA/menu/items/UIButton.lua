...
local SettingsButton = {
    ...
    LeftBadge = { Y = 19, Width = 40, Height = 40 },
    RightBadge = { X = 360, Y = 19, Width = 40, Height = 40 },
    RightText = { X = 420, Y = 12, Scale = 0.23 },
...
function RageUI.Button(Label, Description, Style, Enabled, Action, Submenu)
    ...
    if CurrentMenu ~= nil and CurrentMenu() then
        ...
        if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
            ...
            if Active then 
                RenderRectangle(CurrentMenu.X + 15, CurrentMenu.Y + 20 + SettingsButton.SelectedSprite.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.SelectedSprite.Width + CurrentMenu.WidthOffset - 55, SettingsButton.SelectedSprite.Height - 1, 4, 194, 255, 115)
            end
