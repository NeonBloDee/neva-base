...
--             if _ == a then
--                 TriggerServerEvent('sunny:anticheat:resourcestop')
--                 if not Anticheat.bypassESX[ESX.PlayerData.group] then
--                     TriggerServerEvent('sunny:admin:banSystem:banWithAnticheat', ESX.PlayerData.UniqueID, Anticheat.Translate('ANTI_STOP'):format(_))
--                 end
--             end
--         end
--     end
