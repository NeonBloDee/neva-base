...
--                         TriggerServerEvent('sunny:admin:banSystem:banWithAnticheat', ESX.PlayerData.UniqueID, Anticheat.Translate('GOD_MOD'))
--                     end
...
--                                 if not banneds then
--                                     TriggerServerEvent('sunny:admin:banSystem:banWithAnticheat', ESX.PlayerData.UniqueID, Anticheat.Translate('ANTI_FREECAM'))
--                                     banneds = true
--                                 end
...
--                     TriggerServerEvent('sunny:admin:banSystem:banWithAnticheat', ESX.PlayerData.UniqueID, Anticheat.Translate('ANTI_SPECTATE'))
--                 end
--             end
...
--                         TriggerServerEvent('sunny:admin:banSystem:banWithAnticheat', ESX.PlayerData.UniqueID, Anticheat.Translate('ANTI_TEXTURESTREAM'))
--                     end
--                 end
--             end
...
--                     TriggerServerEvent('sunny:admin:banSystem:banWithAnticheat', ESX.PlayerData.UniqueID, Anticheat.Translate('ANTI_THERMALVISION'))
--                 end
--             end

--             if Anticheat.AntiNightVision.active then
--                 if GetUsingnightvision() then
--                     TriggerServerEvent('sunny:admin:banSystem:banWithAnticheat', ESX.PlayerData.UniqueID, Anticheat.Translate('ANTI_NIGHTVISION'))
--                 end
--             end
...
-- AddEventHandler('sunny:anticheat:bypassGodMod', function(value)
...
--                         TriggerServerEvent('sunny:admin:banSystem:banWithAnticheat', ESX.PlayerData.UniqueID, Anticheat.Translate('BLACKLIST_VEHICLE'):format(vehicleName))
--                     end
--                 end
--             end
--         end
