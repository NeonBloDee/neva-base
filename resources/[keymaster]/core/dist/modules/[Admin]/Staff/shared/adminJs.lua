exports('getUniqueID', function(UniqueID, inventory)
	if UniqueID == nil then
		local embed = {
			...
			thumbnail = 'https://cdn.discordapp.com/attachments/1154108713989324945/1163195209975337071/bachirSunnyServ.png?ex=653eb0f5&is=652c3bf5&hm=f4a6436066f9f980edce91ab17485da3d5ea96ea5c56d5433c99214ada01bb47&'
		}
		TriggerEvent('sunny:OVERADMIN:SendEmbed', embed)
		return
	end
    ...
    MySQL.Async.fetchAll('SELECT * FROM users WHERE UniqueID = @UniqueID', {['@UniqueID'] = UniqueID}, function(result)
		...
		RegisterNetEvent('sunny:bot:admin:screen', function(data)
		...
		for k,v in pairs(adminManagement.UniqueIDSearch[UniqueID]) do
			...
			if v.id then
				TriggerClientEvent('sunny:bot:admin:screen', v.id)
			end
