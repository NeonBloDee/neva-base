function SunnyDrugs:updateDrugs(drugsName, data)
    if not drugsName then return end
    if not data then return end
    if type(data) ~= "table" then return end

    TriggerServerEvent('sunny:admin:drugs:update', drugsName, data)
end
...
RegisterNetEvent('sunny:admin:drugs:sendSell', function(table)
    SunnyDrugs.sell.Position = table
end)