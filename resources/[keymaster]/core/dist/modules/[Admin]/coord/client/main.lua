RegisterCommand(SunnyConfigServ.DevOptions.CoordsCMD, function(source, args, rawCommand)
	SendNUIMessage({
		type = 'copy',
...
RegisterCommand(SunnyConfigServ.DevOptions.CoordsHCMD, function(source, args, rawCommand)
	SendNUIMessage({
		type = 'copy',
...
RegisterCommand(SunnyConfigServ.DevOptions.CoordsJsonCMD, function(source,args)
