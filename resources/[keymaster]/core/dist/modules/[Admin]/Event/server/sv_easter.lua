...
-- RegisterServerEvent('sunny:event:easter:startEvent')
-- AddEventHandler('sunny:event:easter:startEvent', function(easter)
--     local source = source
...
--             TriggerClientEvent('sunny:event:easter:startEvent', -1, activeEventsEggs[eventId])
...
--                 TriggerClientEvent('sunny:event:easter:stopEvent', -1)
...
-- RegisterServerEvent('sunny:event:easter')
-- AddEventHandler('sunny:event:easter', function(itemKey)
--     local source = source
--     local xPlayer = ESX.GetPlayerFromId(source)
...
-- RegisterServerEvent('sunny:event:easter:stopEvent')
-- AddEventHandler('sunny:event:easter:stopEvent', function()
--     TriggerClientEvent('sunny:event:easter:stopEvent', -1)
--     activeEventsEggs = {}
-- end)