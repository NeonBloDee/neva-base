...
function startEvent()
    ...
    TriggerClientEvent('sunny:autoEvent:start', -1, data)
    IsEventLoaded = true
end
...
RegisterNetEvent('sunny:autoEvent:broke', function(data)
    ...
    TriggerClientEvent('sunny:autoEvent:broke', -1, data)
end)

RegisterNetEvent('sunny:autoEvent:secondBroke', function(data)
    local source = source
    if not IsEventLoaded then return end
    TriggerClientEvent('sunny:autoEvent:secondBroke', source, data)
end)

RegisterNetEvent('sunny:autoEvent:take', function(obj, k, money)
    local source = source
    local xPlayer = ESX.GetPlayerFromId(source)
    ...
    TriggerClientEvent('sunny:autoEvent:take', -1, obj, k)
end)


RegisterNetEvent('sunny:autoEvent:stop', function(position)
    if not IsEventLoaded then return end
    TriggerClientEvent('sunny:autoEvent:stop', -1, position)
