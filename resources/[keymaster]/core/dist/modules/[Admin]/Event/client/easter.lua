...
--     RegisterNetEvent('sunny:event:easter:startLaunch', function()
...
--                     onSelected = function()
--                         TriggerServerEvent('sunny:event:easter:startEvent', easter)
--                         RageUI.CloseAll()
--                     end
--                 })
--             end)
...
--     RegisterNetEvent('sunny:event:easter:startEvent')
--     AddEventHandler('sunny:event:easter:startEvent', function(data)
...
--     RegisterNetEvent('sunny:event:easter:stopEvent')
...
--                         onSelected = function()
--                             TriggerServerEvent('sunny:event:easter', k)
--                         end
--                     })
--                 end
--             end)
