...
RegisterNetEvent('events:vehiclesTemporary:client:start', function(id, position, zonePosition, vehicleModel)
    ...
    AddZones(formatName, {
        ...
        marker = false,
        Action = function()
            TriggerServerEvent("events:vehiclesTemporary:server:get", id)
        end
    })
...
RegisterNetEvent('events:vehiclesTemporary:client:stop', function(id)
