...
RegisterCommand(SunnyConfigServ.PileOuFace.Command,function(source, args)
    if IsPlaying then
        return
    end
    IsPlaying = true
...
RegisterNetEvent('tossCoinClient', function(result, coords)
    ...
    local text = result == 1 and SunnyConfigServ.PileOuFace.TextPile or SunnyConfigServ.PileOuFace.TextFace
