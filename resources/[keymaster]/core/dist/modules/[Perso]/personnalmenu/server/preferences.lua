CreateThread(function()
    ...
    AddEventHandler('esx:playerLoaded', function(source, player)
        ...
        TriggerClientEvent('sunny:preferences:recieve', source, playersPreferences[player.UniqueID])
    end)



    RegisterNetEvent('sunny:preferences:add', function(preferName)
        local source = source
        local player = ESX.GetPlayerFromId(source)
    ...
    RegisterNetEvent('sunny:preferences:remove', function(preferName)
        local source = source
        local player = ESX.GetPlayerFromId(source)
