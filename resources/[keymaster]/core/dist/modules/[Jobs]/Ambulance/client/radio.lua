...
local function openRadiographyMenu(job)
    ...
    local radioLimbs = UTILS:formatToList(SunnyAmulance.Ambulance.radiographsLimb)
...
Citizen.CreateThread(function()
    for k,v in pairs(SunnyAmulance.Ambulance.radiographs) do
...
RegisterNetEvent('ambulance:client:startRadiography', function(job)
    local preset = SunnyAmulance.Ambulance.radiographs[job]
