RegisterNetEvent('sunny:society:gouvernement:editTax', function(societyName, tax)
    local source = source
    ...
    TriggerClientEvent('sunny:society:gouvernement:editTax', -1, society.name, society.tax)
...
RegisterNetEvent('sunny:society:gouvernement:editTax2', function(societyName, tax)
    local source = source
    local xPlayer = ESX.GetPlayerFromId(source)
