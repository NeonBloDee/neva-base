-- RegisterNetEvent('sunny:jobs:updateSocietyStatus', function(newVal)
--     local source = source
--     local xPlayer = ESX.GetPlayerFromId(source)

--     if (xPlayer) then
--         TriggerClientEvent('sunny:jobs:updateSocietyStatus', -1, xPlayer.job.name, newVal)
...
-- ESX.RegisterServerCallback('sunny:getSocietyState', function(source, cb)
--     local source = source
--     local society = {}
