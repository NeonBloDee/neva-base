        ...
        RageUI.IsVisible(main, function()
            ...
            RageUI.Checkbox('Service', nil, Bennys.inService, {}, {
                onChecked = function()
                    ...
                    TriggerServerEvent('sunny:bennys:service')
                end,
                onUnChecked = function()
                ...
                RageUI.Button('Réparer véhicule', nil, {}, true, {
                    onSelected = function()
                        ...
                        if IsPedSittingInAnyVehicle(playerPed) then
                            ESX.ShowNotification('~r~Erreur ~w~Vous ne pouvez pas faire sa a l\'intérieur d\'un véhicule')
                            return
                        end
                        ...
                        if DoesEntityExist(vehicle) then
                            ...
                            Citizen.CreateThread(function()
                                ...
                                TriggerServerEvent('sunny:bennys:repairVehicle', GetVehicleNumberPlateText(vehicle))
                            end)
                        else
                            ESX.ShowNotification('~r~Erreur ~w~Aucun véhicule au alentours')
                        end
                    end,
                    onActive = function()
...
--     ESX.TriggerServerCallback('sunny:custom:getVehiclesPrices', function(vehicles)
-- 		Vehicles = vehicles
    ...
    while GetResourceState("ox_target") ~= "started" do Citizen.Wait(500) end
        ...
        exports.ox_target:addGlobalVehicle({
            ...
            onSelect = function(data)
                ...
                TriggerServerEvent("sunny:Service:delVeh", NetworkGetNetworkIdFromEntity(data.entity))
            end
        })
