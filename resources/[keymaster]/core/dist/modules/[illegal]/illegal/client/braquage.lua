...
function CONFIG_BRAQUAGE_MAISON.Start(id)
    ...
    inBraquage = true
    TriggerServerEvent('sunny:braq:setBraq', id)
    TriggerServerEvent('sunny:braq:police:alert', id)
        ...
        CreateThread(function()
            ...
            while inBraquage do 
                ...
                if #fakeTable < 1 then
                    ...
                    TriggerServerEvent('sunny:braq:finish', id)
                ...
                for k,v in pairs(fakeTable) do
                    ...
                    if #(Player.coords-vector3(v.position.x, v.position.y, v.position.z)) < 2 then
                        ...
                        if IsControlJustPressed(0, 54) then
                            ...
                            TriggerServerEvent('sunny:braq:recupObject', v.price)
    ...
    while main do Wait(1)
        RageUI.IsVisible(main, function()
            RageUI.Button('Commencer à Braquer cette Propriété', nil, {RightLabel = '→'}, true, {
                onSelected = function()
                    ESX.TriggerServerCallback('sunny:braq:getItems', function(cb)
...
RegisterNetEvent('sunny:braq:alert', function(id)
...
RegisterNetEvent('sunny:braq:stopalert', function(id)
...
CreateThread(function()
    ...
    AddZones('illegal_shop', {
        Position = SunnyConfigServ.IllegalShops.Pos,
        Dist = 10,
        Public = true,
        Job = nil,
        Job2 = nil,
        ...
        ActionText = 'Appuyez sur [ '..SunnyConfigServ.GTACOLOR..'E~w~ ] pour intéragir',
        Action = function()
