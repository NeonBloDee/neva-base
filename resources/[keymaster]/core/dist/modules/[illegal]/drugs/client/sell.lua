...
--     Wait(8000)
--     local data = SunnyDrugs.sell.Position[math.random(1, #SunnyDrugs.sell.Position)]

--     local callCop = SunnyDrugs.sell.CallCop[math.random(1,10)]
--     local source = source
--     local position = GetPlayerLocation(source)  

--     if callCop then
--         if IsInNorthZone(position) then
--             TriggerClientEvent('sunny:police:drugs:callcopnord', source, data)
--         elseif IsInSouthZone(position) then
--             TriggerClientEvent('sunny:police:drugs:callcop', source, data)
--         else
...
--                                     TriggerServerEvent('sunny:drugs:sell', DrugsListData[DrgusList[drugsIndex]])
...
-- RegisterNetEvent('sunny:drugs:stop', function()
--     stopVente()
-- end)
