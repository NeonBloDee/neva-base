...
Gangs.openCreateMenu = function()
    ...
    while main do Wait(1)
        RageUI.IsVisible(main, function()
            RageUI.Button('Créer un groupe', nil, {RightLabel = '→'}, true, {
                onSelected = function()
                    
                end
            }, main_create)
            RageUI.Button('Gerer les groupes', nil, {RightLabel = '→'}, true, {
                onSelected = function()
                ...
                RageUI.Button('Confirmer la création', nil, {Color = {BackgroundColor = {UTILS.ServerColor.r, UTILS.ServerColor.g, UTILS.ServerColor.b, UTILS.ServerColor.o}}}, true, {
                    onSelected = function()
                        exports['prompt']:createPrompt(
                            ...
                            'Êtes-vous sûr de vouloir confirmer la création de ce gang ?',
                            '',
                            function(response)
                                if response then -- Oui
                                    TriggerServerEvent('sunny:gangs:create', Gangs.Create)
        ...
        RageUI.IsVisible(main_edit_selected, function()
            ...
            RageUI.Button('Supprimer le Gang', nil, {Color = {BackgroundColor = {255,0,0,150}}}, true, {
                onSelected = function()
                    exports['prompt']:createPrompt(
                        SunnyConfigServ.ServerName,
                        'Êtes-vous sûr de vouloir supprimer ce gang ?',
                        '',
                        function(response)
                            if response then -- Oui
                                TriggerServerEvent('sunny:gangs:staff:delete', gangData.name)
            ...
            RageUI.Button('Changer le nom d\'affichage du gang', nil, {RightBadge = RageUI.BadgeStyle.Star}, true, {
                onSelected = function()
                    KeyboardUtils.use('Nouveau nom', function(data)
                        ...
                        exports['prompt']:createPrompt(
                            SunnyConfigServ.ServerName,
                            'Voulez-vous changer le nom du groupe ?',
                            '',
                            function(response)
                                if response then -- Oui
                                    TriggerServerEvent('sunny:gangs:staff:edit', "label", gangData.name, data)
                                    ESX.ShowNotification(('✅ Nom d\'affichage du gang changé pour "%s"'):format(data))
                                    RageUI.GoBack()
                                else -- Non
                                    ESX.ShowNotification('Changement du nom d\'affichage annulé')
                                end
                            end
                        )
                    end)
            ...
            RageUI.Button('Changer la position de la gestion', nil, {RightBadge = RageUI.BadgeStyle.Star}, true, {
                onSelected = function()
                    exports['prompt']:createPrompt(
                        SunnyConfigServ.ServerName,
                        'Êtes-vous sûr de vouloir changer la position de gestion du gang ?', 
                        '',
                        function(response)
                            if response then -- Oui
                                gangData.positions.boss = GetEntityCoords(Player.playerPed)
                                TriggerServerEvent('sunny:gangs:staff:edit', "positions", gangData.name, gangData.positions, true)
                                ESX.ShowNotification('✅ Position de gestion du gang changée avec succès')
                            else -- Non
                                ESX.ShowNotification('Changement de position de gestion annulé') 
                            end
                        end
                    )
                end
            ...
            RageUI.Button('Changer la position du coffre', nil, {RightBadge = RageUI.BadgeStyle.Star}, true, {
                onSelected = function()
                    exports['prompt']:createPrompt(
                        SunnyConfigServ.ServerName,
                        'Êtes-vous sûr de vouloir changer la position du coffre du gang ?',
                        '',
                        function(response)
                            if response then -- Oui
                                gangData.positions.chest = GetEntityCoords(Player.playerPed)
                                TriggerServerEvent('sunny:gangs:staff:edit', "positions", gangData.name, gangData.positions, true)
                                ESX.ShowNotification('✅ Position du coffre du gang changée avec succès')
                            else -- Non
                                ESX.ShowNotification('Changement de position du coffre annulé')
                            end
                        end
                    )
                end
...
RegisterNetEvent('sunny:gangs:recieveGangs', function(data)
    Gangs.List = data
end)
    ...
    while main do Wait(1)
        ...
        RageUI.IsVisible(main, function()
            ...
            RageUI.Button('Gérer les membres', nil, {RightLabel = '→'}, Gangs:havePermission('manage_members'), {
                onSelected = function()
                ESX.TriggerServerCallback('sunny:gangs:gestions:members:fetch', function(cb)
            ...
            if Gangs.CreateGrade.name ~= nil and Gangs.CreateGrade.label ~= nil then
                RageUI.Button('Confirmer la création', nil, {Color = {BackgroundColor = {UTILS.ServerColor.r, UTILS.ServerColor.g, UTILS.ServerColor.b, UTILS.ServerColor.o}}}, true, {
                    onSelected = function()
                        exports['prompt']:createPrompt(
                            SunnyConfigServ.ServerName,
                            'Êtes-vous sûr de vouloir créer ce grade pour le gang ?',
                            '',
                            function(response)
                                if response then -- Oui
                                    TriggerServerEvent('sunny:gangs:gestion:grades:create', gangData.name, Gangs.CreateGrade)
                                    ...
                                    ESX.ShowNotification('Création de grade annulée')
                                end
                            end
                        )
                    end
            ...
            RageUI.Button('Supprimer le grade', nil, {Color = {BackgroundColor = {255,0,0,150}}}, not Gangs.Gestion.Roles.CantRemove[Gangs.Gestion.Roles.Selected.name], {
                onSelected = function()
                    exports['prompt']:createPrompt(
                        ...
                        function(response)
                            if response then -- Oui
                                TriggerServerEvent('sunny:gangs:gestion:grades:delete', gangData.name, Gangs.Gestion.Roles.Selected.name)
                                ESX.ShowNotification('✅ Grade supprimé avec succès')
                                RageUI.GoBack()
                            else -- Non
                                ESX.ShowNotification('Suppression de grade annulée')
                            end
                        end
                    )
                end
            ...
            RageUI.Button('Modifier le Nom D\'affichage', nil, {}, true, {
                onSelected = function()
                    KeyboardUtils.use('Entrée les données', function(data)
                        ...
                        TriggerServerEvent('sunny:gangs:gestion:grades:editLabel', gangData.name, Gangs.Gestion.Roles.Selected.name, data)
            ...
            for k,v in ipairs(Gangs.Permissions) do
                RageUI.Checkbox(v.title, nil, v.enable, {}, {
                    onChecked = function()
                        ...
                        TriggerServerEvent('sunny:gangs:gestion:grades:editGradePermissions', gangData.name, gangData.permissions)
                    end,
                    onUnChecked = function()
                        v.enable = false
        ...
        RageUI.IsVisible(main_manageMembers_actions, function()
            RageUI.Button('Virer la Personne', nil, {}, true, {
                onSelected = function()
                    TriggerServerEvent('sunny:gangs:manage:demotePlayer', selectedMembed)
            ...
            RageUI.Button('Ajouter de l\'argent', nil, {RightLabel = '→'}, Gangs:havePermission('accounts_add'), {
                onSelected = function()
                    KeyboardUtils.use('Ajouter de l\'argent', function(data)
                        ...
                        TriggerServerEvent('sunny:gangs:chest:accounts:add', gangData.name, Gangs.SelectedAccount, data)
                    end)
                end
            })
            RageUI.Button('Retirer de l\'argent', nil, {RightLabel = '→'}, Gangs:havePermission('accounts_remove'), {
                onSelected = function()
                    KeyboardUtils.use('Retirer de l\'argent', function(data)
                        ...
                        TriggerServerEvent('sunny:gangs:chest:accounts:remove', gangData.name, Gangs.SelectedAccount, data)
                    end)
                end
            })
        end)
                ...
                RageUI.Button(v.label, nil, {RightLabel = ('~g~x%s~s~'):format(v.count)}, Gangs:havePermission('items_remove'), {
                    onSelected = function()
                        ...
                        KeyboardUtils.use('Quantité à retirer', function(data)
                            ...
                            TriggerServerEvent('sunny:gangs:chest:items:remove', gangData.name, v, data)
                        end)
                    end
                })
            end
                ...
                RageUI.Button(v.label, nil, {RightLabel = ('~g~x%s~s~'):format(v.count)}, true, {
                    onSelected = function()
                        KeyboardUtils.use('Quantité', function(data)
                            ...
                            TriggerServerEvent('sunny:gangs:chest:items:add', gangData.name, v, data)
                        end)
                    end
                })
            end
            ...
            for k,v in pairs(gangData.chest["weapons"]) do
                RageUI.Button(v.label, nil, {RightLabel = ('~g~x%s~s~'):format(v.count)}, Gangs:havePermission('weapons_remove'), {
                    onSelected = function()
                        ...
                        exports['prompt']:createPrompt(
                            SunnyConfigServ.ServerName,
                            ('Êtes-vous sûr de vouloir prendre %s ?'):format(v.label),
                            '',
                            function(response)
                                if response then -- Oui
                                    TriggerServerEvent('sunny:gangs:chest:weapons:remove', gangData.name, v)
                                else -- Non
                                    ESX.ShowNotification(('Suppression de %s annulée'):format(v.label))
                                end
                            end
                        )
                    end
                ...
                if HasPedGotWeapon(Player.playerPed, GetHashKey(v.name)) then
                    RageUI.Button(v.label, nil, {RightLabel = ('~g~x%s~s~'):format(v.ammo)}, true, {
                        onSelected = function()
                            ...
                            exports['prompt']:createPrompt(
                                SunnyConfigServ.ServerName,
                                ('Êtes-vous sûr de vouloir ajouter %s au coffre du groupe ?'):format(v.label),
                                '',
                                function(response)
                                    if response then -- Oui
                                        TriggerServerEvent('sunny:gangs:chest:weapons:add', gangData.name, v, v.ammo)
                                    else -- Non
                                        ESX.ShowNotification(('Ajout de %s annulé'):format(v.label))
                                    end
                                end
                            )
                        end
        ...
        RageUI.IsVisible(main, function()
            ...
            RageUI.Button('Fouiller la personne', nil, {RightLabel = '→'}, true, {
                onSelected = function()
                    ...
                    ESX.TriggerServerCallback('sunny:gangs:interaction:requestPlayerInventory', function(cb)
            ...
            RageUI.Button('Cagouler/Décagouler la personne', nil, {RightLabel = '→'}, true, {
                onSelected = function()
                    ...
                    TriggerServerEvent("sunny:gangs:interaction:cagoulePlayer", GetPlayerServerId(player))
                end
            })
            if Gangs:havePermission('recruit_remove_player') then
                ...
                RageUI.Button('Virer la personne', nil, {RightLabel = '→'}, true, {
                    onSelected = function()
                        ...
                        TriggerServerEvent('sunny:gangs:interaction:removePlayer', GetPlayerServerId(player))
                    end
                })
            end
            ...
            for k,v in pairs(gangData.grades) do
                RageUI.Button(v.label, nil, {}, true, {
                    onSelected = function()
                        ...
                        TriggerServerEvent('sunny:gangs:interaction:recruitPlayer', GetPlayerServerId(player), gangData.name, v.grade)
...
RegisterNetEvent('sunny:gangs:updateGang', function(name, data)
    Gangs.List[name] = data
end)
RegisterNetEvent('sunny:gangs:delete', function(name)
    Gangs.List[name] = nil
end)
RegisterNetEvent('sunny:gangs:updateChest', function(name, chest)
...
RegisterNetEvent('sunny:gangs:interaction:cagoulePlayer', function(value)
