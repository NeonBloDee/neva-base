RegisterServerEvent('sunny:weapons:checkItems')
AddEventHandler('sunny:weapons:checkItems', function(item1, item2, cb)
...
RegisterServerEvent('sunny:weapons:checkPlayerCategory')
AddEventHandler('sunny:weapons:checkPlayerCategory', function(category, callback)
