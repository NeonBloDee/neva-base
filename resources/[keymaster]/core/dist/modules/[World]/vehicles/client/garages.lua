...
local token = 0
RegisterNetEvent('sunny:garage:retreive:token', function (newToken)
    token = newToken
end)


RegisterNetEvent('sunny:garage:refresh', function(Table)
...
RegisterNetEvent('sunny:garage:refreshBlip', function()
    Garages:InitBlip()
end)

CreateThread(function()
    Wait(1000)
    TriggerServerEvent('sunny:garage:load')
end)
...
function Garages:InitBlip()
    for k,v in pairs(Garages.garage_data.garages) do
        ...
        if v.activeblip == 1 or v.activeblip == true then
            ...
            AddTextComponentString(v.type == 'car' and 'Parking Terrestre' or v.type == 'boat' and 'Parking Nautique' or v.type == 'aircraft' and 'Parking Aérien')
...
CreateThread(function()
    ...
    for k,v in pairs(Garages.garage_data.data.Pounds) do
        for i,p in pairs(Garages.garage_data.data.Pounds[k]) do
            ...
            BeginTextCommandSetBlipName("STRING")
            AddTextComponentString(k == 'car' and 'Fourrière Terrestre' or k == 'boat' and 'Fourrière Nautique' or k == 'aircraft' and 'Fourrière Aérienne')
    ...
    while true do
        ...
        for k,v in pairs(Garages.garage_data.garages) do
            ...
            if distance < 1.5 then
                ...
                --exports['core-ui']:showHelpNotification('Appuyez sur ~p~E~s~ pour intéragir')
    ...
    while main do Wait(1)
        RageUI.IsVisible(main, function()
            ...
            RageUI.Line(UTILS.ServerColor.r, UTILS.ServerColor.g, UTILS.ServerColor.b, UTILS.ServerColor.o)
              --  RageUI.Button('Gérer les véhicules d\'un joueur', nil, {}, true, {
               ...
               --          ESX.TriggerServerCallback('sunny:garage:getInfoPlayer', function(cb)
            ...
            RageUI.Button('Gérer les véhicules (joueur/group/entreprise)', nil, {}, true, {
                onSelected = function()
                    KeyboardUtils.use('Entrée le (ID/Group/Entreprise)', function(data)
                        ...
                        ESX.TriggerServerCallback('sunny:garage:getInfoEntreprise', function(cb)
                            playerInformationsUniqueID = cb
                            playerInformationsUniqueIDInfo = data
        ...
        RageUI.IsVisible(edit_select, function()
                ...
                RageUI.Button('Changer le nom du garage', nil, {}, true, {
                    onSelected = function()
                        KeyboardUtils.use('Nouveau nom', function(data)
                            ...
                            TriggerServerEvent('sunny:garage:edit', Garages.selectedId, Garages.garage_data.garages[Garages.selectedId])
                        end)
                    end
                })
                ...
                for k,v in pairs(Garages.garage_data.garages) do
                    ...
                    RageUI.Checkbox('Afficher le blip', nil, Garages.garage_data.garages[Garages.selectedId].activeblip, {}, {
                        onChecked = function()
                            ...
                            TriggerServerEvent('sunny:garages:edit:blips', 'add', Garages.selectedId)
                        end,
                        onUnChecked = function()
                            Garages.garage_data.garages[Garages.selectedId].activeblip = false
                            TriggerServerEvent('sunny:garage:edit', Garages.selectedId, Garages.garage_data.garages[Garages.selectedId])
                            ESX.ShowNotification('Le blip est désormé inactif')
                            TriggerServerEvent('sunny:garages:edit:blips', 'remove', Garages.selectedId)
                        end
                    })
                end
            end
            ...
            RageUI.Button('Supprimer le garage', nil, {}, Garages.selectedId ~= 1 and Garages.selectedId ~= 2 and Garages.selectedId ~= 3, {
                onSelected = function()
                    TriggerServerEvent('sunny:garage:delete', Garages.selectedId)
                    ...
                    exports['prompt']:createPrompt(
                        ...
                        function(response)
                            if response then -- Oui
                                ...
                                TriggerServerEvent('sunny:garages:delVeh', v.plate)
        ...
        RageUI.IsVisible(Attribueveiculeentreprise, function()
            ...
            RageUI.Button('Confirmer', nil, {}, true, {
                onSelected = function()
                    ...
                    TriggerServerEvent('sunny:garages:attribuevehiculetosociety', plate, labelSpawn, typeSpawn, vehicleProps, playerInformationsUniqueIDInfo)
                    Wait(10)
...
function Garages:create(name, label, type, defaultpos, deletepos, spawnpos, headingspawnpos, activeblip)
    ...
    TriggerServerEvent('sunny:garage:create', name, label, type, defaultpos, deletepos, spawnpos, headingspawnpos, activeblip)
...
function Garages:addBlip(type, pos)
    ...
    SetBlipAsShortRange(GarageBlip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString(type == 'car' and 'Parking Terrestre' or type == 'boat' and 'Parking Nautique' or type == 'aircraft' and 'Parking Aérien')
    EndTextCommandSetBlipName(GarageBlip)
end
        ...
        RageUI.IsVisible(main, function()
            ...
            RageUI.Button('Mes Véhicules', nil, {RightLabel = '→'}, waitvehperso, {
                onSelected = function()
                    ...
                    ESX.TriggerServerCallback('sunny:garage:myvehicle', function(cb)
            ...
            RageUI.Button('Véhicules de Société', nil, {RightLabel = '→'}, Player.job.name ~= "unemployed" and waitvehperso, {
                onSelected = function()
                    ...
                    ESX.TriggerServerCallback('sunny:garage:myvehicle_entreprise', function(cb)
            ...
            RageUI.Button('Véhicules de mon Groupe Illégal', nil, {RightLabel = '→'}, Player.job2.name ~= "unemployed2" and waitvehperso, {
                onSelected = function()
                    ...
                    ESX.TriggerServerCallback('sunny:garage:myvehicle_group', function(cb)
                        ...
                        onSelected = function()
                            ...
                            exports['prompt']:createPrompt(
                                ...
                                function(response)
                                    if response then -- Oui
                                        RageUI.CloseAll()
                                        TriggerServerEvent('sunny:garages:fix:neon', vehicles.plate)
                                    else -- Non
                ...
                RageUI.Button('Renommer', nil, {RightLabel = Garages.my_garage.labelVehicle}, true, {
                    onSelected = function()
                        KeyboardUtils.use('Nouveau nom', function(data)
                            ...
                            TriggerServerEvent('sunny:garages:renamemy_vehicle', vehicles.plate, data, vehiiiiiiicle.owner)
                            Garages.my_garage.VehiclesList = {}
                            ESX.TriggerServerCallback('sunny:garage:myvehicle', function(cb)
                                Garages.my_garage.VehiclesList = cb
                            end)
                ...
                RageUI.Button('Attribuer le véhicule à mon entreprise', nil, {}, ESX.GetPlayerData().job.name ~= "unemployed", {
                    onSelected = function()
                        ...
                        exports['prompt']:createPrompt(
                            ...
                            function(response)
                                if response then -- Oui
                                    ESX.TriggerServerCallback('sunny:garages:checkIfIsBoutique', function(cb)
                                        if cb == true then
                                        ...
                                        TriggerServerEvent('sunny:garages:my_vehicles:setmyentreprise', vehicles.plate, ESX.GetPlayerData().job.name)
                            ...
                            function(response)
                                if response then -- Oui
                                    ESX.TriggerServerCallback('sunny:garages:checkIfIsBoutique', function(cb)
                                        ...
                                        TriggerServerEvent('sunny:garages:my_vehicles:setmygroup', vehicles.plate, ESX.GetPlayerData().job2.name)
...
function Garages:setSateVehicle(plate, value, type, id, properties)
    TriggerServerEvent('sunny:garage:state', plate, value, type, id, properties)
end
...
function Garages:sortVehicle(vehicles, veh, defaultpos, defautheading, plate, garageid, type, k, p)
    ...
    if type ~= 'pound' then
        TriggerServerEvent('sunny:garages:sortVehicle', vehicles, veh, defaultpos, defaultpos.h or 90.0, plate, garageid, type)
    else
        TriggerServerEvent('sunny:garages:sortVehicle', vehicles, veh, coords, head, plate, garageid, type)
    end
...
function Garages:rentVehicle(id, type)
    ...
    local vehicleProps = lib.getVehicleProperties(vehicle)
    ESX.TriggerServerCallback('sunny:garage:getType', function(cb)
...
function Garages:DoesPlateExist(plate)
    ...
    ESX.TriggerServerCallback('sunny:garages:checkPlateInMap', function(cb)
        r = cb
    end, plate) 
