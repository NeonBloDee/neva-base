...
-- AddEventHandler("Sunny:truck:enter", function(netId)
...
--             TriggerEvent("sunny:vehicle:exitTruck")
--         end
...
-- AddEventHandler("sunny:vehicle:exitTruck", function()
--     truckStatut = false
-- end)
...
--                 TriggerEvent("Sunny:truck:enter", NetworkGetNetworkIdFromEntity(data.entity))
--             end
--         }
--     })
-- end)
...
-- --                                 TriggerServerEvent('L-VehiclesInventory:ActionsMoney', vehiclePlate, 'remove', 'cash', inventoryData['accounts'].cash, data)
-- --                             elseif Index == 2 then
-- --                                 TriggerServerEvent('L-VehiclesInventory:ActionsMoney', vehiclePlate, 'deposit', 'cash', inventoryData['accounts'].cash, data)
-- --                             end
-- --                         end)
-- --                     end
-- --                 })
...
-- --                                 TriggerServerEvent('L-VehiclesInventory:ActionsMoney', vehiclePlate, 'remove', 'black_money', inventoryData['accounts'].black_money, data)
-- --                             elseif Index == 2 then
-- --                                 TriggerServerEvent('L-VehiclesInventory:ActionsMoney', vehiclePlate, 'deposit', 'black_money', inventoryData['accounts'].black_money, data)
-- --                             end
-- --                         end)
-- --                     end
-- --                 })
...
-- --                             TriggerServerEvent('L-VehiclesInventory:RemoveItem', vehiclePlate, v, data)
-- --                         end)
-- --                     end
-- --                 })
-- --             end
...
-- --                             TriggerServerEvent('L-VehiclesInventory:DepositItem', vehiclePlate, v, data)
-- --                         end)
-- --                     end
-- --                 })
-- --             end
...
-- --                                 TriggerServerEvent('L-VehiclesInventory:RemoveWeapon', vehiclePlate, v, k) 
-- --                             end
-- --                         end)
-- --                     end
-- --                 })
...
-- --                         KeyboardUtils.use('Tapez Y pour valider', function(data)
-- --                             if data == 'y' or data == 'Y' then
-- --                                 TriggerServerEvent('L-VehiclesInventory:AddWeapon', vehiclePlate, v)
-- --                             end
-- --                         end)
-- --                     end
-- --                 })
