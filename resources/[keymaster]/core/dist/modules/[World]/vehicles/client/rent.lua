    ...
    while menu do
        ...
        RageUI.IsVisible(menuTime, function ()
            RageUI.Button("15 minutes", nil, {}, true, {
                onSelected = function ()
                    RageUI.CloseAll()
                    TriggerServerEvent("Sunny:vehicle:rentVehicle", rentIndex, vehicleSelected, 1)
                end
            })
            ...
            RageUI.Button("30 minutes", nil, {}, true, {
                onSelected = function ()
                    RageUI.CloseAll()
                    TriggerServerEvent("Sunny:vehicle:rentVehicle", rentIndex, vehicleSelected, 2)
                end
            })
            ...
            RageUI.Button("1 heure", nil, {}, true, {
                onSelected = function ()
                    RageUI.CloseAll()
                    TriggerServerEvent("Sunny:vehicle:rentVehicle", rentIndex, vehicleSelected, 3)
                end
            })
        end)
...
RegisterNetEvent("Sunny:vehicle:spawnVehicle")
AddEventHandler("Sunny:vehicle:spawnVehicle", function(vehicleName, rentTime)
...
RegisterNetEvent("Sunny:vehicle:removeVehicle")
AddEventHandler("Sunny:vehicle:removeVehicle", function()
    local playerPed = PlayerPedId()
    ...
    while true do
        ...
        if rentEndTime then
            ...
            if remainingTime > 0 then
                ...
                TriggerEvent("Sunny:vehicle:removeVehicle")
            end
        end
    end
end)
