...
local VehicleDealer = {
    ...
    position = {
        ...
        ['cardealer'] = {
            management = vector3(-318.702881, -814.515137, 32.752106), actions = vector3(-318.702881, -814.515137, 32.752106), spawn = vec3(-298.201721, -760.745850, 33.969109), heading = 338.55270385742, blips = {
                category = nil,
