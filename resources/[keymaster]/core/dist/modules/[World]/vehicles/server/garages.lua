...
ESX.RegisterServerCallback('sunny:vehicles:getCustom', function(source, cb, plate)
...
ESX.RegisterServerCallback('sunny:garages:checkIfIsBoutique', function(source, cb, plate)
    local source = source
...
RegisterNetEvent('sunny:garages:sortVehicle', function(vehicles, veh, defaultpos, defautheading, plate, garageid, typee)
    local source = source
    ...
    TriggerClientEvent('sunny:garages:setvehicleProperties', source, sss[xPlayer.UniqueID].netId, veh, sss[xPlayer.UniqueID].vehicleId, veh.plate)

    TriggerClientEvent('esx:showNotification', source, '✅ Véhicule sorti avec succès')
end)


ESX.RegisterServerCallback('sunny:garages:checkPlateInMap', function(source, cb, plate)
...
function Garages:refresh()
    Wait(500)
    TriggerClientEvent('sunny:garage:refresh', -1, Garages.garage_data.garages)
end
...
RegisterNetEvent('sunny:garage:load', function()
    local source = source
    Wait(5000)
    TriggerClientEvent('sunny:garage:refresh', source, Garages.garage_data.garages)
end)

RegisterNetEvent('sunny:garage:create', function(name, label, type, defaultpos, deletepos, spawnpos, headingspawnpos, activeblip)
    local source = source
...
RegisterNetEvent('sunny:garage:edit', function(id, Table)
    local source = source
...
RegisterNetEvent('sunny:garages:edit:blips', function(value, id)
    TriggerClientEvent('sunny:garages:edit:blips', -1, value, id)
end)

ESX.RegisterServerCallback('sunny:garage:myvehicle', function(source, cb)
    local source = source
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('sunny:garage:myvehicle_group', function(source, cb)
    local source = source
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('sunny:garage:myvehicle_entreprise', function(source, cb)
    local source = source
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback("sunny:garage:getType", function(source, cb, plate, properties)
    local source = source
    local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterNetEvent('sunny:garages:my_vehicles:setmygroup', function(plate, job)
    local source = source
...
RegisterNetEvent('sunny:garages:my_vehicles:setmyentreprise', function(plate, job)
    local source = source
...
RegisterNetEvent('sunny:garage:state', function(plate, value, type, id, properties)
    local source = source
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('sunny:garage:paidPound', function(source, cb)
    local source = source
    local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterNetEvent('sunny:garage:delete', function(id)
...
ESX.RegisterServerCallback('sunny:garage:getInfoPlayer', function(source, cb, uniqueid)
...
ESX.RegisterServerCallback('sunny:garage:getInfoEntreprise', function(source, cb, uniqueid)
    local source = source
    local UniqueIdInfo = {}
...
RegisterNetEvent('sunny:garages:renamemy_vehicle', function(plate, newName)
    local source = source
...
RegisterNetEvent('sunny:garages:attribuevehiculetosociety', function(plate, label, type, vehicleProps, s)
    local source = source
...
RegisterNetEvent('sunny:garages:delVeh', function(plate)
    local source = source
...
AddEventHandler('esx:PlayerLoaded', function(source)
    ...
    TriggerClientEvent('sunny:garage:retreive:token', source)
end)

RegisterNetEvent('sunny:garages:fix:neon', function (vehicle, clToken)
    local source = source
