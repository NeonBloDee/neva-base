...
--             black_money = 0
--         },
--         vehiclePound = SunnyVehiclesConfig.Limit.GTA[vehicle.class],
--         pound = 0,
--     }
...
-- RegisterNetEvent('L-VehiclesInventory:DepositItem', function(vehiclePlate, itemData, count)
--     local source = source
...
-- RegisterNetEvent('L-VehiclesInventory:RemoveItem', function(vehiclePlate, itemData, count)
--     local source = source
--     local xPlayer = ESX.GetPlayerFromId(source)
--     if not xPlayer then return end
...
-- RegisterNetEvent('L-VehiclesInventory:AddWeapon', function(vehiclePlate, weaponData)
--     local source = source
--     local xPlayer = ESX.GetPlayerFromId(source)
...
-- RegisterNetEvent('L-VehiclesInventory:RemoveWeapon', function(vehiclePlate, weaponData, weaponId)
--     local source = source
--     local xPlayer = ESX.GetPlayerFromId(source)
--     if not xPlayer then return end
...
-- RegisterNetEvent('L-VehiclesInventory:ActionsMoney', function(vehiclePlate, action, type, money, count)
--     local source = source
--     local xPlayer = ESX.GetPlayerFromId(source)
--     if not xPlayer then return end
