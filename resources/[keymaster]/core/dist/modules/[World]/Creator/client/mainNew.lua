...
-- RegisterNetEvent('sunny:createPlayer')
-- AddEventHandler('sunny:createPlayer', function()
--     SetEntityCoords(PlayerPedId(), vector3(-670.1601, 585.7462, 140.5699))
--     SetEntityHeading(PlayerPedId(), 219.35406494141)
--     TriggerServerEvent('sunny:caca:setInstance')
...
--             TriggerServerEvent('sunny:creator:save:identity', CREATOR_DATA)
--         end
--     end
-- end)
...
--                 TriggerEvent('sunny:createPlayer')
--             end
--         end)
-- 	end)
-- end)