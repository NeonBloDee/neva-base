Citizen.CreateThread(function()
    --[[RegisterNetEvent('sunny:save')
     AddEventHandler('sunny:save', function (data)   
         local src = source
     ...
     ESX.RegisterServerCallback('sunny:getData', function(source, cb)
         local src = source
         local xPlayer = ESX.GetPlayerFromId(source)
     ...
     --[[RegisterCommand('register', function(source, args)
         TriggerClientEvent('sunny:openCreator', args[1])
     end)]]--
