-- RegisterNetEvent("sunny:creator:save:identity", function(ident)
--     local source = source
...
-- --     TriggerClientEvent('sunny:createPlayer', source)
-- -- end)

-- RegisterNetEvent('sunny:caca:setInstance', function()
--     local source = source
--     Wait(100)
--     SetPlayerRoutingBucket(source, source)
-- end)

-- RegisterNetEvent('sunny:caca:sortInstance', function()
--     local source = source
--     SetPlayerRoutingBucket(source, 0)
-- end)
...
--     if player then
--         TriggerClientEvent('sunny:createPlayer', player.id)
--     else
--         TriggerClientEvent('sunny:createPlayer', xPlayer.source)
--     end
-- end)