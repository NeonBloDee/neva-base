...
-- RegisterNetEvent('sunny:fishing:boutique:buyRod', function(name, price)
--     local source = source
--     local xPlayer = ESX.GetPlayerFromId(source)
...
--     TriggerClientEvent('sunny:boutique:recieveboutique', source, VehiclesBoutique)
-- end)

-- RegisterNetEvent('sunny:staff:boutique:addvehicle', function(name, label, price, type)
--     VehiclesBoutique = {}
...
--             TriggerClientEvent('sunny:boutique:recieveboutique', -1, VehiclesBoutique)
--         end)
--     end)
-- end)

-- RegisterNetEvent('sunny:staff:boutique:removevehicle', function(name)
--     VehiclesBoutique = {}
