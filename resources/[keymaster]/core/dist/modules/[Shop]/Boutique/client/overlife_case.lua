...
--     RageUI.Button('Caisse ~y~VEHICULES~s~ x1', nil, {RightLabel = (SunnyConfigServ.GTACOLOR..'%s~s~'):format(BoutiqueConfig['Case']['vehicle_case'].price[1])}, true, {
--         onSelected = function()
...
--             --         TriggerServerEvent('sunny:boutique:case:buy', 'vehicle_case', BoutiqueConfig['Case']['vehicle_case'].price[1], 1)
