...
--     Citizen.Wait(2000)
--     TriggerEvent('sunny:boutique:openCase', caseId)
-- end
...
-- RegisterNetEvent('sunny:boutique:openCase', function(caseId)
...
--             TriggerServerEvent('sunny:giveBoutiqueReward', reward, reward.vehicleProps, caseId)

--             RageUI.CloseAll()
--         end)
--     else
--         TriggerServerEvent('sunny:giveBoutiqueReward', reward, nil, caseId)
