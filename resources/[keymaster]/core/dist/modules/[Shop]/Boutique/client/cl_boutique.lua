...
RegisterNetEvent('sunny:boutique:recieveboutique', function(data)
...
--             RageUI.Info(('%sBoutique de %s~s~'):format(UTILS.COLORCODE, SunnyConfigServ.ServerName), {'Code Boutique', 'Nombre de Points', 'Points Utilisé(s)'}, {ESX.PlayerData.UniqueID, InfoPlayer.coins, InfoPlayer.totalCoins})
    
--             RageUI.Button('Acheter des points boutiques', nil, {RightLabel = '→'}, true, {
--                 onSelected = function()
--                     ExecuteCommand('openUrl '..SunnyConfigServ.Boutique)
--                 end
--             })
...
--                     onSelected = function()
--                         RageUI.CloseAll()
--                         TriggerServerEvent('sunny:boutique:sendReward')
--                     end
--                 })
--             end
...
--                     onSelected = function()
--                         TriggerServerEvent("sunny:server:BuyCustom", weaponData.name, v.hash, selected)
--                     end
--                 })
--             end
--         end)
...
--                 if v.boutique then
--                     RageUI.Button(v.label, nil, {RightBadge = RageUI.BadgeStyle.Star, RightLabel = SunnyConfigServ.GTACOLOR .. v.price}, true, {
--                         onSelected = function()
--                             exports['prompt']:displayRequest(
...
--                                         return
--                                     end
--                                     TriggerServerEvent('sunny:fishing:boutique:buyRod', v.name, v.price)
--                                 end,
--                                 function()
...
--                     onActive = function()
--                         RageUI.Info(('%sBoutique de %s~s~'):format(UTILS.COLORCODE, SunnyConfigServ.ServerName), {'Avantages:', 'Accès au menu VIP', 'Salaire ~g~1500~s~', 'Fourrière ~g~Gratuite~s~'}, {''})
--                     end,
--                     onSelected = function()
...
--                             function()
--                                 TriggerServerEvent('sunny:vip:buy')
--                             end,
--                             function()
--                                 ESX.ShowNotification("Achat annulé")
--                             end
...
--                             function()
--                                 TriggerServerEvent('sunny:vip:renew')
--                             end,
--                             function()
...
--                 RageUI.Button(v.label, nil, {RightLabel = (SunnyConfigServ.GTACOLOR..'%s~s~'):format(v.price)}, true, {
--                     onActive = function()
--                         RageUI.RenderCaissePreview("case", v.name)
--                     end,
--                     onSelected = function()
--                         if InfoPlayer.coins >= v.price then
--                             TriggerServerEvent('sunny:weapon:paid', v.price, v.name)
--                         else
...
--                         exports['prompt']:displayRequestttt(
--                             'Confirmer l\'achat',
...
--                                 TriggerServerEvent('sunny:boutique:paidCase', caisse_selected)
--                             end,
--                             function() -- Non
...
--                 RageUI.List(v.label.. (" [%s]"):format(v.type), liistt, innnndex, nil, {RightLabel = (SunnyConfigServ.GTACOLOR..'%s~s~'):format(v.price)}, true, {
...
--             RageUI.Separator(('Il vous reste : '..SunnyConfigServ.GTACOLOR..'%s~s~ secondes'):format(IsTimeBoutique or 10))
--         end)
