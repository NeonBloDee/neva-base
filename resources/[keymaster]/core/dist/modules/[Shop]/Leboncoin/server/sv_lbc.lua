...
CreateThread(function()
    MySQL.Async.fetchAll("SELECT * FROM player_leboncoin ", {}, function(result)
        ...
        print('^7ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ')
        print('^0[^5 N E V A ^0] ^7Base N E V A : ^5https://discord.gg/neva-fivem')
        print('^7ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ')
        print('^5------------------------------------------------')
        print('^7ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ')
        print('^7 NN     NN    EEEEEE   VV       VV      AAA     ')
        print('^7 NNN    NN              VV     VV      AA AA    ')
        print('^7 NN NN   N    EEEEE      VV   VV      AA   AA   ')
        print('^7 NN  NN       EE          VV VV      AA     AA  ')
        print('^7 NN   NNN     EEEEEE       VVV      AA       AA ')
        print('^7ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ')
        print('^7                  Corporation                   ')
        print('^7ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ')
        print("^5===============================================")
        print("^2            Version 5.0.86 Loaded             ")
        print("^5===============================================")
        print('^7ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ')
...
AddEventHandler('esx:playerLoaded', function(source)
    ...
    MySQL.Async.fetchAll("SELECT * FROM vente_leboncoin WHERE UniqueID = @UniqueID", {
        ...
        if #result > 0 then 
            ...
            xPlayer.showNotification(SunnyConfigServ.GTACOLOR.."Slide~w~Vous avez vendu des objets sur leboncoin, allez dés maintenant récupérer votre argent !")
            TriggerClientEvent("SunnyLpb:recieveventeplayer", xPlayer.source, InfosVente[xPlayer.UniqueID])
        else
        end
    end)
end)
...
RegisterNetEvent("SunnyLpb:recieveannoncelbc")
AddEventHandler("SunnyLpb:recieveannoncelbc", function()
    local xPlayer = ESX.GetPlayerFromId(source)
    
    if not LeBonCoin[xPlayer.UniqueID] then 
        LeBonCoin[xPlayer.UniqueID] = {}
        TriggerClientEvent("SunnyLpb:recieveclientsideannoncelbc", xPlayer.source, nil)
    else
        TriggerClientEvent("SunnyLpb:recieveclientsideannoncelbc", xPlayer.source, LeBonCoin[xPlayer.UniqueID])
    end
end)

-- Cb toutes les annonces 
RegisterNetEvent('SunnyLpb:cballannonces')
AddEventHandler('SunnyLpb:cballannonces',function()
    TriggerClientEvent('SunnyLpb:cballannoncesafter', source, LeBonCoinAll)
end)

-- Mise en vente d'un item
RegisterNetEvent("SunnyLpb:lbcventeitem")
AddEventHandler("SunnyLpb:lbcventeitem", function(label, name, countt, price, infos)
    if SunnyConfigServ.BlackListItem[name] ~= nil then 
    ...
    if Verif then 
        ...
        xPlayer.showAdvancedNotification(SunnyConfigServ.ServerName, "Leboncoin", "Vous avez déposer une annonce de x"..countt.." "..label.." au prix de ~r~"..price.."", "CHAR_CALIFORNIA", 8)
        if not LeBonCoin[xPlayer.UniqueID][Valide] then 
            ...
            TriggerClientEvent("SunnyLpb:recieveclientsideannoncelbc", source, LeBonCoin[xPlayer.UniqueID])
...
RegisterNetEvent("SunnyLpb:lbcventeveh")
AddEventHandler("SunnyLpb:lbcventeveh", function(props, plate, price, label, infos, typeee)
    local CountVeh = 0
    local src = source
    local xPlayer = ESX.GetPlayerFromId(source)
    local Id1 = math.random(11111, 999999)
    ...
    for k, v in pairs(LeBonCoinAll) do 
        if v.plate == plate then 
            xPlayer.showNotification(SunnyConfigServ.GTACOLOR.."Slide~w~Se véhicule est déjà en vente !")
            return
        end
    end
    ...
    if CountVeh >= 5 then
        xPlayer.showNotification(SunnyConfigServ.GTACOLOR..'Slide ~w~Vous avez déjà 5 véhicules en vente !')
        return
    end
	MySQL.Async.fetchAll("SELECT * FROM owned_vehicles WHERE owner=@UniqueID and plate =@plate",{
        ...
        if #data >= 1 then 
            ...
            if not LeBonCoin[xPlayer.UniqueID][Valide] then 
                ...
                TriggerClientEvent("SunnyLpb:recieveclientsideannoncelbc", src, LeBonCoin[xPlayer.UniqueID])
                ...
                xPlayer.showNotification(SunnyConfigServ.GTACOLOR.."Slide~w~Vous avez mis votre véhicule en vente")
            ...
            xPlayer.showNotification(SunnyConfigServ.GTACOLOR..'Slide~w~Ce véhicule ne vous appartient pas')
        end
	end)
end)

-- Update/Delete d'une annonce 
RegisterNetEvent("SunnyLpb:updateannoncelbc")
AddEventHandler("SunnyLpb:updateannoncelbc", function(typee, id, price, typeee)
    local xPlayer = ESX.GetPlayerFromId(source)
    ...
    if Veriflicense then 
        if VerifType == "del" then 
            if typeee == "veh" then 
                ...
                xPlayer.showNotification(SunnyConfigServ.GTACOLOR.."Slide~w~Vous avez supprimé votre annonce ")
...
--Achat d'un item 
RegisterNetEvent("SunnyLpb:buyobjlbc")
AddEventHandler("SunnyLpb:buyobjlbc", function(id, UniqueID, quant)
    local xPlayer = ESX.GetPlayerFromId(source)
        ...
        if xPlayer.getAccount('cash').money >= tonumber(LeBonCoin[UniqueID][id].price)*tonumber(quant) then
            if xPlayer.canCarryItem(LeBonCoin[UniqueID][id].name, tonumber(quant)) then
                if tPlayer ~= nil then 
                    ...
                    tPlayer.showNotification(SunnyConfigServ.GTACOLOR.."Slide~w~Vous avez vendu ~r~x"..quant.." de ~s~~r~"..LeBonCoin[UniqueID][id].label.."~s~Vous avez reçu l'argent sur votre compte bancaire")
                else
                ...
                if tPlayer ~= nil then 
                    TriggerClientEvent("SunnyLpb:recieveclientsideannoncelbc", tPlayer.source, LeBonCoin[UniqueID])
                end
                TriggerClientEvent("SunnyLpb:recieveclientsideannoncelbc", xPlayer.source, LeBonCoin[xPlayer.UniqueID])
            else
                xPlayer.showNotification(SunnyConfigServ.GTACOLOR..'Slide ~w~Vous êtes trop lourd pour acheter ces objets.')
            end
        else
            xPlayer.showNotification("Vous n'avez pas les fonds nécéssaires")
        end
    else
        xPlayer.showNotification(SunnyConfigServ.GTACOLOR..'Slide ~w~Il n\'y a pas assez d\'objets dans cette annonce.')
    end
end)

-- Achat d'un véhicule
RegisterNetEvent("SunnyLpb:achatveh")
AddEventHandler("SunnyLpb:achatveh", function(id, UniqueID)
    ...
    if VerifPlate then 
        ...
        if tPlayer ~= nil then 
            ...
            tPlayer.showNotification(SunnyConfigServ.GTACOLOR.."Slide~w~Vous avez votre véhicule ~r~"..LeBonCoin[UniqueID][id].plate.."~s~Vous avez reçu l'argent sur votre compte bancaire")
        else
           -- ADD L ARGENT AU JOUEUR QUAND IL EST PAS CO
            MySQL.Async.execute("INSERT INTO vente_leboncoin (UniqueID, price) VALUES (@UniqueID, @price)", {
                ["@UniqueID"] = UniqueID,
        ...
        LeBonCoin[UniqueID][id] = nil
        xPlayer.showNotification(SunnyConfigServ.GTACOLOR.."Slide~w~Vous venez d'acheté le véhicule !")
    end
end)

--Event lorsque le joueur récupère son argent
RegisterNetEvent("SunnyLpb:recupmoneyvente")
AddEventHandler("SunnyLpb:recupmoneyvente", function(id, UniqueID, price)
    local xPlayer = ESX.GetPlayerFromId(source)
    ...
    if verif then 
        if InfosVente[xPlayer.UniqueID][id].price == price then 
            ...
            xPlayer.showNotification(SunnyConfigServ.GTACOLOR.."Slide~w~Vous avez encaisser une somme de ~r~"..price.."")
            InfosVente[xPlayer.UniqueID][id] = nil 
            TriggerClientEvent("SunnyLpb:recieveventeplayer", source, InfosVente[xPlayer.UniqueID])
...
RegisterNetEvent("SunnyLpb:bucketlbcplayer")
AddEventHandler("SunnyLpb:bucketlbcplayer", function(active)
...
RegisterNetEvent('Sunny:getInformations',function()
    local xPlayer = ESX.GetPlayerFromId(source)
    if LeBonCoin[xPlayer.UniqueID] then
        TriggerClientEvent('SunnyLpblegrosfdp:sendLBCInfo', source, LeBonCoin[xPlayer.UniqueID], LeBonCoinAll)
    else
        TriggerClientEvent('SunnyLpblegrosfdp:sendLBCInfo', source, nil, LeBonCoinAll)
    end
end)