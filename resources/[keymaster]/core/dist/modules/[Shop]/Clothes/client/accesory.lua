...
--   vec3(-711.690918, -158.953705, 37.415077),
--   vec3(-157.562576, -300.383514, 39.733246),
--   vec3(-817.068115, -1073.690918, 11.327923),
--   vec3(-1456.450317, -237.476471, 49.801678),
...
-- RegisterNetEvent('sunny:accessories:update', function(data)
--     if not (data) then data = {} end
--     accessories.myData = data
-- end)

-- RegisterNetEvent('sunny:accessories:add', function(index, data)
--     accessories.myData[index] = data
-- end)

-- RegisterNetEvent('sunny:accessories:delete', function(index)
--     accessories.myData[index] = nil
-- end)

-- RegisterNetEvent('sunny:accessories:rename', function(index,newLabel)
--     accessories.myData[index].label = newLabel
-- end)

-- local bagList = {}

-- AddEventHandler("Sunny:skinchanger:sendBagConfig", function(data)
--     bagList = data
-- end)
...
--             type2 = 'mask_2',
--             id = 1, 
--             defaultIndex = exports.sunny:GetPlayerSkinData('mask_1') or 1,
--             defaultIndex2 = exports.sunny:GetPlayerSkinData('mask_2') or 1,
--             zoomOffset = 0.6,
--             camOffset = 0.65,
--             price = 15,
--         },
...
--             type2 = 'helmet_2',
--             id = 0,
--             defaultIndex = exports.sunny:GetPlayerSkinData('helmet_1') or 1,
--             defaultIndex2 = exports.sunny:GetPlayerSkinData('helmet_2') or 1,
--             zoomOffset = 0.6,
--             camOffset = 0.65,
--             price = 30,
--         },
...
--             type2 = 'bags_2',
--             id = 5,
--             defaultIndex = exports.sunny:GetPlayerSkinData('bags_1') or 1,
--             defaultIndex2 = exports.sunny:GetPlayerSkinData('bags_2') or 1,
--             zoomOffset = 0.75,
--             camOffset = 0.15,
--             price = 10,
--         },
...
--             type2 = 'bproof_2',
--             id = 9,
--             defaultIndex = exports.sunny:GetPlayerSkinData('bproof_1') or 1,
--             defaultIndex2 = exports.sunny:GetPlayerSkinData('bproof_2') or 1,
--             zoomOffset = 0.75,
--             camOffset = 0.15,
--             price = 100,
--         },
...
--             type2 = 'chain_2',
--             id = 7,
--             defaultIndex = exports.sunny:GetPlayerSkinData('chain_1') or 1,
--             defaultIndex2 = exports.sunny:GetPlayerSkinData('chain_2') or 1,
--             zoomOffset = 0.75,
--             camOffset = 0.15,
--             price = 35,
--         },
...
--             type2 = 'ears_2',
--             id = 2,
--             defaultIndex = exports.sunny:GetPlayerSkinData('ears_1') or 1,
--             defaultIndex2 = exports.sunny:GetPlayerSkinData('ears_2') or 1,
--             zoomOffset = 0.6,
--             camOffset = 0.65,
--             price = 20,
--         },
...
--             type2 = 'watches_2',
--             id = 6,
--             defaultIndex = exports.sunny:GetPlayerSkinData('watches_1') or 1,
--             defaultIndex2 = exports.sunny:GetPlayerSkinData('watches_2') or 1,
--             zoomOffset = 0.75,
--             camOffset = 0.15,
--             price = 30,
--         },
...
--             type2 = 'bracelets_2',
--             id = 7,
--             defaultIndex = exports.sunny:GetPlayerSkinData('bracelets_1') or 1,
--             defaultIndex2 = exports.sunny:GetPlayerSkinData('bracelets_2') or 1,
--             zoomOffset = 0.75,
--             camOffset = 0.15,
--             price = 20,
--         },
...
--             type2 = 'glasses_2',
--             id = 1,
--             defaultIndex = exports.sunny:GetPlayerSkinData('glasses_1') or 1,
--             defaultIndex2 = exports.sunny:GetPlayerSkinData('glasses_2') or 1,
--             zoomOffset = 0.6,
--             camOffset = 0.65,
--             price = 10,
--         },
...
--         DrawMissionText('Appuyez sur '..SunnyConfigServ.GTACOLOR..'[E]~s~ et ~p~[F]~s~ pour tourner la vue.', 500)
...
--                             TriggerServerEvent("Sunny:buyAccessories", data)
--                         end
--                     })
--                 end
--             end
