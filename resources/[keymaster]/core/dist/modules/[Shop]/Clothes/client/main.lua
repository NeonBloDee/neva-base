...
-- RegisterNetEvent('sunny:clotheshop:refreshClothes', function()
--     ESX.TriggerServerCallback('sunny:clotheshop:getMyClothes', function(data) 
--         myClothes = data
--     end)
-- end)
...
--                 onSelected = function()
--                     ESX.TriggerServerCallback('sunny:clotheshop:haveMoney', function(valid)
--                         changeTenue = true
--                         if (valid) then 
...
--                 onSelected = function()
--                     ESX.TriggerServerCallback('sunny:clotheshop:haveMoneySave', function(valid)
--                         if (valid) then
--                             changeTenue = true
...
--                                 TriggerServerEvent('sunny:clotheshop:saveTenue', tempTableVet, input)
--                             end)
...
--                     onSelected = function()
--                         TriggerServerEvent("Sunny:clotheshop:getClothes", SelectedClothes.id)
--                     end
--                 })
...
--                         TriggerServerEvent('sunny:clotheshop:renameClothe', SelectedClothes.id, input)
--                         RageUI.GoBack()
--                     end
--                 })
--                 RageUI.Button('Supprimer la tenue', nil, {}, true, {
--                     onSelected = function()
--                         TriggerServerEvent('sunny:clotheshop:deleteClothe', SelectedClothes.id)
--                         RageUI.GoBack()
--                     end
--                 })
--             end
