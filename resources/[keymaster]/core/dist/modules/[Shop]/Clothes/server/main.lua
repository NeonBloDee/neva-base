...
--     ESX.RegisterServerCallback('sunny:clotheshop:getMyClothes', function(source, cb)
...
--     ESX.RegisterServerCallback('sunny:inventory:getMyClothes', function(source, cb)
--         local xPlayer = ESX.GetPlayerFromId(source)
...
--     end)
--     ESX.RegisterServerCallback('sunny:inventory:getMyClothesByName', function(source, cb, name)
--         local xPlayer = ESX.GetPlayerFromId(source)
--         print(name)
--         if not xPlayer then return end
...
--     ESX.RegisterServerCallback('sunny:clotheshop:haveMoney', function(source, cb)
--         local xPlayer = ESX.GetPlayerFromId(source)
...
--     ESX.RegisterServerCallback('sunny:clotheshop:haveMoneySave', function(source, cb)
--         local xPlayer = ESX.GetPlayerFromId(source)
...
--     RegisterNetEvent('sunny:clotheshop:saveTenue', function(data, t)
--         local source = source
--         local xPlayer = ESX.GetPlayerFromId(source)
...
--     RegisterNetEvent('sunny:clotheshop:renameClothe', function(name, newName)
--         local source = source
--         local xPlayer = ESX.GetPlayerFromId(source)
...
--     RegisterNetEvent('sunny:clotheshop:deleteClothe', function(name, newName)
--         local source = source
--         local xPlayer = ESX.GetPlayerFromId(source)
...
--     RegisterNetEvent('sunny:clothesShop:sendClothes', function(name)
--         local source = source
--         local xPlayer = ESX.GetPlayerFromId(source)
...
--     RegisterNetEvent('sunny:paidaccesoires', function(Name, name, accesories)
--         local source = source
--         local xPlayer = ESX.GetPlayerFromId(source)
