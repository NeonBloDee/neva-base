-- RegisterNetEvent('sunny:supermarket:paidItem', function(data, item, price, count)
--     local source = source
...
-- RegisterNetEvent('sunny:supermarket:paidWeapon', function(data, item, price, count)
--     local source = source
--     local xPlayer = ESX.GetPlayerFromId(source)
--     local type = 'cash'
...
ESX.RegisterServerCallback('sunny:getMoney', function(source, cb)
    local source = source
    local xPlayer = ESX.GetPlayerFromId(source)
