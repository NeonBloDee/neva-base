...
function LSLIFE_UTILS:openShopUi(typeShop)
    TriggerEvent('sunny:openNuiShop', typeShop)
end
CreateThread(function()
    while not HasStreamedTextureDictLoaded("commonmenu") do Wait(150) end
    TextureMenu = CreateDui(SunnyConfigServ.BannerMenu, 512, 128)
...
CreateThread(function()
    while not HasStreamedTextureDictLoaded("commonmenu") do Wait(150) end
    TextureMenu = CreateDui(SunnyConfigServ.BannerButton, 512, 64)
...
PermWeaponByFramework.List = SunnyConfigServ.PermanantWeapon

function SunnyConfigServ.PermanantWeapon(weapon)
...
exports('getParmanantWeapon', function(weapon)
	return SunnyConfigServ.PermanantWeapon(weapon)
end)
