...
ESX.RegisterServerCallback('sunny:livraisons:getLivraisons', function(source, cb)
...
RegisterNetEvent('sunny:livraisons:startFoodUber', function()
    local source = source
    local xPlayer = ESX.GetPlayerFromId(source)

    local livraisons = _LIVRAISONS.init(xPlayer)

    TriggerClientEvent('sunny:livraisons:startFoodUber', source, _LIVRAISONS.levels[xPlayer.UniqueID], _LIVRAISONS.gains[xPlayer.UniqueID], _LIVRAISONS.totalLivraisons[xPlayer.UniqueID], _LIVRAISONS.vehicle[xPlayer.UniqueID])

    TriggerClientEvent('sunny:livraisons:setDestination', source, 'start')
end)

RegisterNetEvent('sunny:livraisons:dest', function()
    local source = source

    TriggerClientEvent('sunny:livraisons:setDestination', source)
end)

RegisterNetEvent('sunny:livraisons:setNewLiv', function()
    local source = source
    local xPlayer = ESX.GetPlayerFromId(source)
    ...
    _LIVRAISONS.gains[xPlayer.UniqueID] = SunnyConfigServ.Activity.Livraisons.Levels[_LIVRAISONS.levels[xPlayer.UniqueID]] or _LIVRAISONS.gains[xPlayer.UniqueID]
    ...
    _LIVRAISONS.vehicle[xPlayer.UniqueID] = SunnyConfigServ.Activity.Livraisons.Vehicle[_LIVRAISONS.levels[xPlayer.UniqueID]] or _LIVRAISONS.vehicle[xPlayer.UniqueID]
    if SunnyConfigServ.Activity.Livraisons.Vehicle[_LIVRAISONS.levels[xPlayer.UniqueID]] ~= nil then
        ...
        TriggerClientEvent('sunny:livraisons:newVehicle', source)
    end

    TriggerClientEvent('sunny:livraisons:update', source, _LIVRAISONS.levels[xPlayer.UniqueID], _LIVRAISONS.gains[xPlayer.UniqueID], _LIVRAISONS.totalLivraisons[xPlayer.UniqueID], _LIVRAISONS.vehicle[xPlayer.UniqueID])
