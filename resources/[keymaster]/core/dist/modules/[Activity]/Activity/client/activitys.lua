function ActiviTyssetPickUpPlayerAnimation(item)
    ...
    TriggerServerEvent('sunny:activitys:pickUpItem', item)
end
...
function ActiviTyssetPickUpTraitementPlayerAnimation(item, itemt)
    ...
    TriggerServerEvent('sunny:activitys:traitementItem', item, itemt)
end
...
function ActiviTyssetPickUpVentePlayerAnimation(item)
    ...
    TriggerServerEvent('sunny:activitys:venteItem', item)
end

CreateThread(function()

    for k,v in pairs(SunnyConfigServ.Activity.Blips) do
    ...
    for k,v in pairs(SunnyConfigServ.Activity.ZoneBlips) do
    ...
    for k,v in pairs(SunnyConfigServ.Activity.Peds) do
        _PEDS.addPed(k, {
            model = v.model,
    ...
    AddZones("chasse_start", {
        Position = SunnyConfigServ.Activity.Chasse.Pos,
        Dist = 10,
        Public = true,
        Job = nil,
        Job2 = nil,
    ...
    local RandomZoneAcier = SunnyConfigServ.Activity.Acier[math.random(1, #SunnyConfigServ.Activity.Acier)]
    local AcierX,AcierY,AcierZ = RandomZoneAcier.x + math.random( 1, #SunnyConfigServ.Activity.Acier ), RandomZoneAcier.y + math.random( 1, #SunnyConfigServ.Activity.Acier ), RandomZoneAcier.z

    local RandomZoneTAcier = SunnyConfigServ.Activity.TAcier[math.random(1, #SunnyConfigServ.Activity.TAcier)]
    local TAcierX,TAcierY,TAcierZ = RandomZoneTAcier.x + math.random( 1, #SunnyConfigServ.Activity.TAcier ), RandomZoneTAcier.y + math.random( 1, #SunnyConfigServ.Activity.TAcier ), RandomZoneTAcier.z

    local RandomZoneVAcier = SunnyConfigServ.Activity.VAcier[math.random(1, #SunnyConfigServ.Activity.VAcier)]
    local VAcierX,VAcierY,VAcierZ = RandomZoneVAcier.x + math.random( 1, #SunnyConfigServ.Activity.VAcier ), RandomZoneVAcier.y + math.random( 1, #SunnyConfigServ.Activity.VAcier ), RandomZoneVAcier.z
        ...
        -- for k,v in pairs(Activity.Acier) do
            ...
            if distAcier < 1.5 then
                ...
                if IsControlJustPressed(1,51) then
                    RandomZoneAcier = SunnyConfigServ.Activity.Acier[math.random(1, #SunnyConfigServ.Activity.Acier)]
                    AcierX,AcierY,AcierZ = RandomZoneAcier.x + math.random( 1, #SunnyConfigServ.Activity.Acier ), RandomZoneAcier.y + math.random( 1, #SunnyConfigServ.Activity.Acier), RandomZoneAcier.z
            ...
            if distTAcier < 1.5 then
                ...
                if IsControlJustPressed(1,51) then
                    RandomZoneTAcier = SunnyConfigServ.Activity.TAcier[math.random(1, #SunnyConfigServ.Activity.TAcier)]
                    TAcierX,TAcierY,TAcierZ = RandomZoneTAcier.x + math.random( 1, #SunnyConfigServ.Activity.TAcier ), RandomZoneTAcier.y + math.random( 1, #SunnyConfigServ.Activity.TAcier), RandomZoneTAcier.z
            ...
            if distVacier < 1.5 then
                ...
                if IsControlJustPressed(1,51) then
                    RandomZoneVAcier = SunnyConfigServ.Activity.VAcier[math.random(1, #SunnyConfigServ.Activity.VAcier)]
                    VAcierX,VAcierY,VAcierZ = RandomZoneVAcier.x + math.random( 1, #SunnyConfigServ.Activity.VAcier ), RandomZoneVAcier.y + math.random( 1, #SunnyConfigServ.Activity.VAcier), RandomZoneVAcier.z
