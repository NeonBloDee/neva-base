...
--     ESX.RegisterServerCallback('sunny:christmas:calendar:fetch', function(source, cb)
--         local source = source 
...
--     RegisterNetEvent('sunny:christmas:calendar:paidPackage', function(packageNumber)
--         local source = source
--         local xPlayer = ESX.GetPlayerFromId(source)
