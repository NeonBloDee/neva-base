...
--                         onActive = function()
--                             exports['core-ui']:drawInfo(v.informations.title, v.informations.data)
--                         end,
--                         onSelected = function()
...
--                                     TriggerServerEvent('sunny:loupToucheTouche:party:start', GAMES.MY_PARTY[GAMES.PARTY_CREATE_SELECTED].id, GAMES.PARTY_CREATE_SELECTED)
--                                 end
--                             end)
--                         end
--                     })
...
--                             TriggerServerEvent('sunny:loupToucheTouche:party:addPlayer', GAMES.PARTY[GAMES.PARTY_SELECTED][GAMES.PARTY_CREATE_SELECTED].id, GAMES.PARTY_CREATE_SELECTED, GAMES.PARTY[GAMES.PARTY_SELECTED][GAMES.PARTY_CREATE_SELECTED].players)
--                         end)
--                     end
--                 })
--             end)
...
--                         TriggerServerEvent('sunny:loupToucheTouche:CreateParty', GAMES.MY_PARTY[GAMES.PARTY_CREATE_SELECTED].id, GAMES.MY_PARTY[GAMES.PARTY_CREATE_SELECTED])
...
--     RegisterNetEvent('sunny:loupToucheTouche:party:updatePlayers', function(partyId, partyType, partyPlayers)
...
--             exports['SunnyServTextui']:drawText(('👋 Vous avez %s secondes pour vous dispercer'):format(formatted_time))
--             while true do 
--                 Wait(1000)
...
--             exports['SunnyServTextui']:drawText(('👋 Temps restants: %s minutes'):format(GAMES.PARTY[partyId][partyType].time))
...
--                 exports['SunnyServTextui']:drawText(('👋 Temps restants : %02d secondes'):format(formatted_time))
