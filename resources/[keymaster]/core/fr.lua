Locales['fr'] = {
	...
	['WEATHER_NOTIFICATION_HURRICANE'] = "Alerte Météo : Ouragan et vents destructeurs 🌀",
	  ...
	  ['remaining_msg'] = 'il reste '..SunnyConfigServ.GTACOLOR..'%s~s~ secondes avant votre sortie de prison',
	  ['jailed_msg'] = '%s est maintenant en prison pour %s minutes',
	  ['unjailed'] = '%s a été libéré de prison !',

	  ['shop_robbery'] = 'braquage magasin',
	  ['press_to_rob'] = 'appuyez sur ~INPUT_CONTEXT~ '..SunnyConfigServ.GTACOLOR..'pour braquer~s~ '..SunnyConfigServ.GTACOLOR..'%s~s~',
	  ['robbery_timer'] = 'braquage magasin: il reste '..SunnyConfigServ.GTACOLOR..'%s~s~ secondes',
	  ['recently_robbed'] = 'ce magasin a déjà été braqué. Attendez '..SunnyConfigServ.GTACOLOR..'%s'..SunnyConfigServ.GTACOLOR..' secondes.',
	  ['rob_in_prog'] = SunnyConfigServ.GTACOLOR..'Braquage en cours à: '..SunnyConfigServ.GTACOLOR..'%s~s~',
	  ['started_to_rob'] = 'vous avez commencé à braquer '..SunnyConfigServ.GTACOLOR..'%s~s~',
	  ['alarm_triggered'] = 'l\'alarme a été déclenchée',
	  ['robbery_complete'] = SunnyConfigServ.GTACOLOR..'Braquage terminé~s~. Vous avez '..SunnyConfigServ.GTACOLOR..'volé~s~ ~g~$%s~s~',
	  ['robbery_complete_at'] = SunnyConfigServ.GTACOLOR..'Braquage terminé à: '..SunnyConfigServ.GTACOLOR..'%s~s~',
	  ['robbery_cancelled'] = 'le braquage va être annulé, vous ne gagnerez rien!',
	  ['robbery_cancelled_at'] = SunnyConfigServ.GTACOLOR..'Braquage annulé à: '..SunnyConfigServ.GTACOLOR..'%s~s~',
	  ['min_police'] = 'il faut minimum '..SunnyConfigServ.GTACOLOR..'%s policiers~s~ en ville pour braquer.',
	  ['robbery_already'] = SunnyConfigServ.GTACOLOR..'Un braquage est déjà en cours.',
	  ['no_threat'] = 'vous ne constituez aucune menace pour la boutique',

	  ['unlocked'] = '~g~Ouvert',
	  ['locked'] = SunnyConfigServ.GTACOLOR..'Fermé',
	  ...
	  ['invoices'] = 'factures',
	  ['invoices_item'] = '$%s',
	  ['received_invoice'] = 'vous avez '..SunnyConfigServ.GTACOLOR..'reçu~s~ une facture',
	  ['paid_invoice'] = 'vous avez ~g~payé~s~ une facture de '..SunnyConfigServ.GTACOLOR..'$%s~s~',
	  ...
	  ['target_no_money'] = 'the player '..SunnyConfigServ.GTACOLOR..'does not~s~ have enough money to pay the bill!',
	...
	['installed'] = 'installé',
	['already_own'] = 'vous possédez déjà: '..SunnyConfigServ.GTACOLOR..'%s~s~',
  ...
  -- Cosmetics
	...
	-- Paint Colors
	  ...
	  -- anticheat
	  ['spawn_type_vehicle'] = 'Spawn '..SunnyConfigServ.GTACOLOR..'',
	  ...
	  ['press_to_rob'] = 'appuyer sur ~INPUT_CONTEXT~ pour braquer '..SunnyConfigServ.GTACOLOR..'',
	  ['robbery_of'] = 'braquage de banque: ~r~',
	  ['seconds_remaining'] = '~w~ secondes restantes',
	  ['robbery_cancelled_at'] = '~r~ Braquage annulé à: '..SunnyConfigServ.GTACOLOR..'',
	  ['robbery_has_cancelled'] = '~r~ le braquage à été annulé: '..SunnyConfigServ.GTACOLOR..'',
	  ['already_robbed'] = 'cette banque a déjà été braqué. Veuillez attendre: ',
	  ['seconds'] = 'secondes.',
	  ['rob_in_prog'] = '~r~ braquage en cours à: '..SunnyConfigServ.GTACOLOR..'',
	  ...
	  ['robbery_complete_at'] = '~r~ Braquage terminé à: '..SunnyConfigServ.GTACOLOR..'',
