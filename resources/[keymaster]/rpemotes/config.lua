...
Config = {
    ...
    MenuImage = "https://media.discordapp.net/attachments/1022209715037536348/1094323613487878214/baniere_2.png", ----[Custom banner IMGUR or GIPHY URLs go here ]---
    ...
    RagdollEnabled = true,
    RagdollKeybind = 'F9', -- Get the button string here https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
