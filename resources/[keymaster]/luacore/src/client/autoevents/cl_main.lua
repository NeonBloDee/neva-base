...
RegisterNetEvent("Sunny:SendEvent")
AddEventHandler("Sunny:SendEvent", function(data, zone)
    EventStop = false
...
RegisterNetEvent("Sunny:StopEvent")
AddEventHandler("Sunny:StopEvent", function(data, zone)
