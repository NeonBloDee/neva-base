...
-- RegisterServerEvent('Sunny:GiveItem')
-- AddEventHandler('Sunny:GiveItem', function(playerId, selectedItem)
...
--             TriggerClientEvent('esx:showNotification', _source, SunnyConfigServ.GTACOLOR..'SlideRP Message~w~ \n Votre sac poubelle est déchirée')
--         end
...
-- RegisterServerEvent('Sunny:Givesac')
-- AddEventHandler('Sunny:Givesac', function()
--     local _source = source
--     local xPlayer = ESX.GetPlayerFromId(_source)
