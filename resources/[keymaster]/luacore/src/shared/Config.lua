...
Afk = {
    ...
    -- ⚠️La chance est un numéro sur le total de récopenses de la caisse !!!!!!
    ...
    Case = {
        ...
        {label = 'Caisse 1', name = 'Caisse Diamond', price = 1000, rewards = {
            ...
            {label = 'Pistolet', name = 'pistol', type = 'weapon', count = 1, chance = 1},
            ...
            {label = 'Pioche Arc en ciel', name = 'rainbowsmash', type = 'weapon', count = 1, chance = 2},
        }},
        ...
        {label = 'Caisse 2', name = 'Caisse Ruby', price = 1500, rewards = {
            ...
            {label = 'Pistolet Cal50', name = 'pistol50', type = 'weapon', count = 1, chance = 3},
