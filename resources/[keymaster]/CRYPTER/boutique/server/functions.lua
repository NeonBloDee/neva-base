...
local vehicles = {
    ...
    [GetHashKey("gbclubxr")] = "Club XR",
    [GetHashKey("gbeon")] = "Eon",
    [GetHashKey("hycrh7")] = "Hy7",
    [GetHashKey("gbsentinelgts")] = "Sentinel GTS",
    [GetHashKey("gbschrauber")] = "Schrauber",
    [GetHashKey("estancia")] = "Estancia",
    [GetHashKey("audace")] = "Audace",
    [GetHashKey("cycloneex0")] = "Cyclone EX",
    [GetHashKey("gb811s2")] = "811 S2",

    -- Caisse Argent
    [GetHashKey("issi8s")] = "Issi 8S",
    [GetHashKey("turtle")] = "Turtle",
    [GetHashKey("space")] = "Space",
    [GetHashKey("elegyheritage")] = "Elegy Heritage",
    [GetHashKey("nriata")] = "Riata N",
    [GetHashKey("shinobir")] = "Shinobi R",
    [GetHashKey("sheavas")] = "Sheavas",
    [GetHashKey("gstghell1")] = "Hell L1",
    [GetHashKey("asteropers")] = "Asterope RS",
    [GetHashKey("dubsta22")] = "Dubsta 22",
    [GetHashKey("gbneonct")] = "Neon CT",
    [GetHashKey("H4RxST2")] = "H4R",
    [GetHashKey("schlagenstr")] = "Schlagen STR",
    [GetHashKey("tempestas")] = "Tempesta S",
    [GetHashKey("cuban800")] = "Cuban 800",
    
    -- Caisse Or
    [GetHashKey("sentinel_rts")] = "Sentinel RTS",
    [GetHashKey("highmare")] = "Highmare",
    [GetHashKey("gbtahomagt")] = "TahomaGT",
    [GetHashKey("cypherct")] = "Cypher CT",
    [GetHashKey("bati901")] = "Bati 901",
    [GetHashKey("gbsultanrsx")] = "Sultan RSX",
    [GetHashKey("gbbisonhf")] = "Bison HF",
    [GetHashKey("gbesperta")] = "Esperta",
    [GetHashKey("kqrumpo")] = "Rumpo Aménagé",
    [GetHashKey("tempestaes")] = "Tempesta ES",
    [GetHashKey("deimos")] = "Deimos",
    [GetHashKey("hellfirelastcall")] = "Hellfire LC",
    [GetHashKey("gbsapphire")] = "Sapphire",
    [GetHashKey("gbcomets1t")] = "Comet S1T",
    [GetHashKey("turismocs")] = "Turismo CS",
    [GetHashKey("neross")] = "Nero S",
    [GetHashKey("gbprospero")] = "Prospero",
    [GetHashKey("gbcomets2r")] = "Comet S2R",
    [GetHashKey("buzzard2")] = "Buzzard",
    [GetHashKey("tug")] = "Tugboat",

    -- Caisse Hivernale
    [GetHashKey("gbdominatorgsx")] = "Dominator GSX",
    [GetHashKey("gbbanshees")] = "Banshee S",
    [GetHashKey("gbvivant")] = "Vivant",
    [GetHashKey("gbstarlight")] = "Starlight",
    [GetHashKey("gbargento7f")] = "Argento 7F",
    [GetHashKey("gbturismogt")] = "Turismo GT",
    [GetHashKey("elegyx")] = "Elegy X",
    [GetHashKey("gbmogulrs")] = "Mogul RS",
    [GetHashKey("gbcomets2rc")] = "Comet S2RC",
    [GetHashKey("superd3")] = "Super D3",
    [GetHashKey("gbsolace")] = "Solace",
    [GetHashKey("gbcometcl")] = "Comet CL",
    [GetHashKey("coqvice")] = "Coqvice",
    [GetHashKey("hurricane")] = "Hurricane",
    [GetHashKey("gblod4")] = "Cyber",
    [GetHashKey("gbtr3s")] = "TR-3S",
