...
------ JOBS -----
    ...
    Ambulance = {
        ...
        items = {
            ['seringue_morphine'] = {label = 'Seringe de Morphine', event = 'sunny:ambulance:useItem', args = 'seringue_morphine'},
            ['seringue_morphine2'] = {label = 'Seringe de Morphine 2', event = 'sunny:ambulance:useItem', args = 'seringue_morphine2'},
            ['seringue_acide'] = {label = "Seringe d'Acide", event = 'sunny:ambulance:useItem', args = 'seringue_acide'}
        },
