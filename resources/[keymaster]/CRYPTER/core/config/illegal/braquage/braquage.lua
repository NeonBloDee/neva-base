...
Banks = {
	["fleeca"] = {
		position = vector3(148.863159, -1048.745483, 29.365602),
...
CONFIG_BRAQUAGE_MAISON = {
	List = {
		...
		-- {name = "Braquage de Boite de Nuit", position = vector3(870.790710, -2100.567383, 30.460381), interior = vector3(354.709442, 299.712280, 104.037025), objects = {
		-- 	{
		-- 		position = vec3(351.095001, 284.933594, 91.190025),
		-- 		price = math.random(300,900)
		-- 	},
		-- 	{
		-- 		position = vec3(356.071472, 281.686340, 94.191040),
		-- 		price = math.random(300,900)
		-- 	},
		--         {
		-- 		position = vec3(383.921753, 279.176971, 94.990990),
		-- 		price = math.random(300,900)
		-- 	},
		--         {
		-- 		position = vec3(390.568817, 269.736786, 94.991043),
		-- 		price = math.random(300,900)
		-- 	},
		--         {
		-- 		position = vec3(389.758057, 272.829071, 94.991043),
		-- 		price = math.random(300,900)
		-- 	},
		--         {
		-- 		position = vec3(382.901398, 272.914154, 94.991051),
		-- 		price = math.random(300,900)
		-- 	}
		-- }},
