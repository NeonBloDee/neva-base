...
SunnyConfigServ = {
    ...
    IpLock = "N E V A",
    ServerName = 'N E V A',
    Discord = "https://discord.gg/neva-fivem",
    Reglement = "https://guide.neva-corp.site/guide",
    CfxConnect = "https://discord.gg/neva-fivem",
    LogoUrl = "https://i.ibb.co/VHFyJN6/SECURITY-Logo-Blanc-Plan-de-travail-1.png",
    Boutique = "https://neva-fivem.tebex.io/",
    Slots = 2048,
    Emojie = "🩵",
    ...
    ------ PREFECTURE ------
    PosPrefecture = vec3(-548.093262, -190.913849, 38.223087),
    ...
    Elevator = {
        positions = {
        -- {label = '6', position = vector3(-1095.751099, -850.664856, 38.243240), t = 'police'},
        --   {label = '5', position = vector3(-1095.899658, -850.675903, 34.360725), t = 'police'},
        --    {label = '4', position = vector3(-1096.035400, -850.602966, 30.757151), t = 'police'},
        --    {label = '3', position = vector3(-1095.853882, -850.829285, 26.827585), t = 'police'},
        {label = 'Acceuil', position = vector3(-813.9734, -692.7267, 28.0600), t = 'wiwang'},
        {label = 'Rooftop', position = vector3(-813.5087, -683.5192, 123.4243), t = 'wiwang'},
        --    {label = '-3', position = vector3(-1095.815430, -850.651184, 13.687372), t = 'police'},
        --    {label = '-2', position = vector3(-1096.226318, -850.430664, 10.276630), t = 'police'},
        --    {label = '-1', position = vector3(-1095.999390, -850.680603, 4.884181), t = 'police'},
        },
    
        acceuil = {
            pos = {
                ['LSPD'] = {
                    pos = vec3(-577.885315, -407.822998, 35.181652),
                ...
                ['EMS'] = {
                    pos = vec3(-491.09194946289, -983.00726318359, 24.288093566895),
                ...
                ['Concessionnaire Moto'] = {
                    pos = vec3(-863.40795898438, -194.00482177734, 37.843143463135),
                ...
                ['lscustom'] = {
                    pos = vec3(-357.845306, -131.380753, 39.037022),
                    message = "Un personnel du LSCustom est attendu à l'accueil",
                    job = 'lscustom',
                    label = "LSCustom"
                },
                ['airdealer'] = {
                ...
                ['realestateagent'] = {
                    pos = vec3(-697.156677, 269.811951, 83.109138),
    ...
    WeaponInBack = {
        ...
        compatable_weapon_hashes = {
                ...
                ["w_me_guitare"] = GetHashKey("Sunny_GUITARE"),
    ...
    Fishing = {
        ...
        PosSell = vector3(-1837.855469, -1200.024292, 14.303367),
        fishList = {
            ...
            FishList = {
                ['douce'] = {
                    {label = 'Poisson Chat', name = 'poissonchat', price = 250, rarity = 8/20, moulinage = 5},
                    {label = 'Carassin', name = 'carassin', price = 300, rarity = 8/20, moulinage = 6},
                    {label = 'Carpe commune', name = 'carpecommune', price = 450, rarity = 6/20, moulinage = 7},
                    {label = 'Carpe miroir', name = 'carpemiroir', price = 600, rarity = 5/20, moulinage = 8},
                    {label = 'Carpe koï', name = 'carpekoi', price = 800, rarity = 3/20, moulinage = 9},
                    {label = 'Silure', name = 'silure', price = 1200, rarity = 1/20, moulinage = 11},
                },
                ['mer'] = {
                    {label = 'Anchois', name = 'anchois', price = 300, rarity = 8/20, moulinage = 5},
                    {label = 'Éperlant', name = 'eperlant', price = 400, rarity = 8/20, moulinage = 6},
                    {label = 'Hareng', name = 'hareng', price = 600, rarity = 6/20, moulinage = 7},
                    {label = 'Bar', name = 'bar', price = 800, rarity = 5/20, moulinage = 8},
                    {label = 'Cabillaud', name = 'cabillaud', price = 1200, rarity = 3/20, moulinage = 9},
                    {label = 'Dorade', name = 'dorade', price = 1500, rarity = 2/20, moulinage = 11},
                },
                ['ocean'] = {
                    {label = 'Sardine', name = 'sardine', price = 400, rarity = 8/20, moulinage = 5},
                    {label = 'Thon', name = 'thon', price = 500, rarity = 8/20, moulinage = 6},
                    {label = 'Saumon', name = 'saumon', price = 700, rarity = 6/20, moulinage = 7},
                    {label = 'Sole', name = 'sole', price = 1000, rarity = 5/20, moulinage = 8},
                    {label = 'Raie', name = 'raie', price = 1500, rarity = 3/20, moulinage = 9},
                    {label = 'Requin', name = 'requin', price = 3000, rarity = 0.3/20, moulinage = 11},
                }
            },
    
            FishingRod = {
                {name = 'canneapeche', label = 'Canne à Pêche', price = 7500, boost = 0, boutique = false, fish = 25},
                {name = 'canneapechecarbonne', label = 'Canne à Pêche en carbone', price = 15000, boost = 2, boutique = false, fish = 50},
                {name = 'canneapecheoretcarbonne', label = 'Canne à Pêche alliage Or et Carbone', price = 3500, boost = 5, boutique = true, fish = 850}
            },
    
            FishingLures = {
                ['douce'] = {
                    name = 'douce_lures', label = 'Appât d\'Eau Douce', price = 200,
                },
                ['mer'] = {
                    name = 'mer_lures', label = 'Appât d\'Eau de Mer', price = 200,
                },
                ['ocean'] = {
                    name = 'ocean_lures', label = 'Appât d\'Eau Profonde', price = 200,
                }
            },
            ...
            Zones = {
                ['douce'] = {
                    ...
                    {zone = 'Zone de Pêche (Eau Douce)', position = vector3(1490.915161, 3927.897705, 33.767445), radius = 1000.0, color = 25},
                    {zone = 'Zone de Pêche (Eau Douce)', position = vector3(-192.986359, 790.536682, 198.107605), radius = 500.0, color = 25},
                },
                ['mer'] = {
                ...
                ['ocean'] = {
                    {zone = 'Zone de Pêche (Eau Profonde)', position = vector3(-722.5606, 7102.517, 6.2777), radius = 1000.0, color = 76},
                    {zone = 'Zone de Pêche (Eau Profonde)', position = vector3(993.8589, 7485.11, 3.306886), radius = 1000.0, color = 76},
                    {zone = 'Zone de Pêche (Eau Profonde)', position = vector3(4856.959, 4986.772, 4.037685), radius = 1000.0, color = 76},
                }
            },
        ...
        CheckPoints = {
            {
                ...
                Action = function(playerPed, vehicle, setCurrentZoneType)
                    DrawMissionText(("Allez vers le prochain passage! Vitesse limite: ~y~%s~s~ km/h"):format(SunnyConfigServ.ConfigAutoEcole.SpeedLimits['residence']), 5000)
                end
            },
            {
            ...
            },
            {
                ...
                Action = function(playerPed, vehicle, setCurrentZoneType)
                    ...
                    Citizen.CreateThread(function()
                        DrawMissionText(("Marquer rapidement un ~r~stop~s~ et regardez à votre ~y~gauche~s~. Vitesse limite: ~y~%s~s~ km/h"):format(SunnyConfigServ.ConfigAutoEcole.SpeedLimits['town']), 5000)
                        PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', false, 0, true)
                        FreezeEntityPosition(vehicle, true)
                        Citizen.Wait(6000)
                        FreezeEntityPosition(vehicle, false)
            ...
            },
            {
                ...
                Action = function(playerPed, vehicle, setCurrentZoneType)
                    ...
                    DrawMissionText(("Il est temps d'aller sur la rocade! Vitesse limite: ~y~%s~s~ km/h"):format(SunnyConfigServ.ConfigAutoEcole.SpeedLimits['freeway']), 5000)
                    PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', false, 0, true)
                end
            },
            {
            ...
            },
            {
                ...
                Action = function(playerPed, vehicle, setCurrentZoneType)
                    setCurrentZoneType('town')
                    DrawMissionText(("Entrée en ville, attention à votre vitesse! Vitesse limite: ~y~%s~s~ km/h"):format(SunnyConfigServ.ConfigAutoEcole.SpeedLimits['town']), 5000)
                end
            },
            {
    ...
    Activity = {
        ...
        Acier = {
            vector3(1524.508667, -2533.405762, 57.350464),
            vector3(1514.370972, -2535.396973, 56.591576),
            vector3(1515.976685, -2525.407715, 56.476440)
        },
        TAcier = {
        ...
        Blips = {
            {
                pos = vector3(1519.234009, -2528.691895, 56.822128),
                blipid = 285,
                blipcolor = 36,
    ...
    MaintenancePerm = {
        ...
        Maintenance = {
            Staff = {
                ["license:968abcbb2dced60f0e6caeea28c431b744430742"] = true, -- SunnyServ,
            },
        },
    },
    ...
    weatherCFG = {
        weathers = {
            ...
            -- -- Été       | 1 Juin - 15 Septembre
            -- "EXTRASUNNY",
            -- "CLEAR",
            -- "CLEARING",
            -- "SMOG",

            -- -- Automne   | 15 Septembre - 1 Décembre
            -- "OVERCAST",
            -- "FOGGY",
            -- "RAIN",
            -- "CLOUDS",
