...
Config.InterfaceColor = "#74c0fc" -- change interface color, color must be in hex
...
Config.VehicleTelevisionEvent = false --TriggerServerEvent("nv_tv:InstallVehicleTVCustom", vehicleplate, vehiclenetworkid) --clientside export for check if vehicle have installed tv exports["nv_tv"]:HasVehicleTV(vehicle) Only works for qbcore and esx!
...
Config.EnableVideosFromFolder = true -- enable this if you want play videos which is in nv_tv/html/videos folder, you must add also video name and filename in Config.VideoList
...
Config.VideoList = {
	["video1"] = {
		...
		filename = "video2.mp4", -- video file name (you need place the video to nv_tv/html/videos folder)
	},
	["video2"] = {
		videoname = "test", -- video name, this name you will write to the video url in the input of the tv to play it
		filename = "video2.mp4", -- video file name (you need place the video to nv_tv/html/videos folder)
...
Config.TelevisionObjects = {
	...
	{
		object = "rdzk_cs_sandy_cinema_ui", --object name 
		maxdistance = 15.0, --max distance for display screen
		maxcontroldistance = 15.0, -- max distance for control tv (its cannot be higher than maxdistance)
		rendertarget = true, -- enable render target 
		rendertargetname = "tvscreen", -- render target name
