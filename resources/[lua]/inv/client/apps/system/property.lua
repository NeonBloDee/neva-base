...
function setPropertyData(id)
    ...
    TriggerServerCallback("lgdddd:getChestProperty", function(data)
        Property.items = {}
        weight = data.weight
...
RegisterNUICallback("PutIntoProperty", function(data, cb)
    ...
    if data.item.type == 'item_vetement' then
        ...
        TriggerServerEvent("lgd:actionProperty", 'deposit', item)
...
RegisterNUICallback("TakeFromProperty", function(data, cb)
    ...
    if data.item.type == 'item_vetement' then
        ...
        TriggerServerEvent("lgd:actionProperty", 'remove', item)
