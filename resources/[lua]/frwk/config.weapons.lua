...
Config.Weapons = {
...

	{
		...
		label = _U("weapon_honeybadgercod"),
		components = {
			-- Chargeur
...

	{
		name = 'WEAPON_G17GEN5',
		label = 'Glock-17',
		label = _U("weapon_g17gen5"),
		components = {}
	},

	{
		name = 'WEAPON_COMBATPISTOLPOL',
		label = 'Pistolet de combat',
		label = _U("weapon_combatpistolpol"),
		components = {}
	},
