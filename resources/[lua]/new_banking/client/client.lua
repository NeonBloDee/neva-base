...
local banks = {
	...
	{name="Pacific Bank", id=106, x=251.619293, y=224.157028, z=106.286888, principal = true},
	{name="Bank", id=108, x=1175.0643310547, y=2706.6435546875, z=38.094036102295},
	-- {name="Bank", id=108, x=1735.295166, y=3632.291260, z=35.453625}
}
...
local atms = {
	{name="ATM", id=277, x=-386.733, y=6045.953, z=31.501},
		...
		{name="ATM", id=277, x=239.6773, y=216.1686, z=106.2821},
		...
		{name="ATM", id=277, x=1734.892334, y=3645.710449, z=34.940491},
}
--================================================================================================
...
if bankMenu then
	Citizen.CreateThread(function()
		while true do
			...
			if nearBank() then
				isNearby = true
				DisplayHelpText("Appuie sur ~INPUT_PICKUP~ pour accèder à tes comptes ~p~")
