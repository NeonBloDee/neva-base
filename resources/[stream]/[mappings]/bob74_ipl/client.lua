CreateThread(function()
    ...
    local function LoadCayoPerico()
        if not islandLoaded then
            print("^2Chargement de l'île de Cayo Perico...^0")
            -- Correct methods for loading Cayo Perico
    ...
    local function UnloadCayoPerico()
        if islandLoaded then
            print("^1Déchargement de l'île de Cayo Perico...^0")
            -- Correct methods for unloading Cayo Perico
